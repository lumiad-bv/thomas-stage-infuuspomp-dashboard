  ...
  <body class="bg-white dark:bg-black">
    ...
    <section class="md:flex 4xl:h-[88.9vh] md:h-[85vh] dark:bg-black">
      ...
      >
        ...
        <div class="bg-gray-200 static flex-initial p-5 mt-2 h-[24vh] rounded-[1vw] content-center" v-if="!inBasket">
        ...
        <div class="bg-gray-200 static flex-initial p-5 mt-2 h-[24vh] rounded-[1vw] content-center" v-else>
