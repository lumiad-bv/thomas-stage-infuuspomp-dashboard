...
const backgroundColour = computed(() => {
  if (props.id_stack_number === selectedButtoneStore.pressedButtonId) {
    return "border border-gray-500 rounded-xl bg-blue-600 shadow hover:bg-blue-500 text-white cursor-pointer"
  }
  return "border border-gray-500 rounded-xl bg-white shadow hover:bg-blue-500 hover:text-white cursor-pointer"
})
</script>
