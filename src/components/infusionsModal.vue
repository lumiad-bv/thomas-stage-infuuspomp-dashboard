...
<template>
  <div class="fixed inset-0 bg-black/70  flex justify-center items-center z-50">
    <div class="bg-white shadow-2xl overflow-x-auto flex flex-col max-w-3xl w-full rounded-md">
      ...
      <!-- Header -->
      <header class="flex justify-between items-center px-4 py-3 border-b border-gray-200 text-teal-600 font-semibold">
      ...
      <!-- Infusion items -->
      <div v-for="item in infusions" :key="item.id || item.id_stack_number" class="mb-2 px-4">
