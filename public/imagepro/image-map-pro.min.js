...
;(() => {
  var __webpack_modules__ = {
          ...
          a = (function () {
            function t(e, n) {
              ;(0, o.Z)(this, t),
                ...
                (this.options.default_style.stroke_width = parseInt(
                  this.options.default_style.stroke_width,
                )),
                (this.options.mouseover_style.stroke_width = parseInt(
                  this.options.mouseover_style.stroke_width,
                )),
                (this.options.mouseover_style.background_type =
                  this.options.default_style.background_type),
                  ...
                  value: function () {
                    ...
                    return (
                      'image' === this.options.default_style.background_type &&
                        ((t += '#imp-image-backgrounds-'
                          .concat(this.store.getID(), ' [data-object-id="')
                          .concat(this.options.id, '"] {')),
                        (t += 'background-image: url('.concat(
                          this.options.default_style.background_image_url,
                          ');',
                        )),
                        (t += 'opacity:'.concat(
                          this.options.default_style.background_image_opacity,
                          ';',
                        )),
                        (t += 'transform: scale('
                  ...
                  value: function () {
                    ...
                    return (
                      'image' === this.options.default_style.background_type &&
                        ...
                        ((t.style.left =
                          this.options.x +
                          this.options.default_style.background_image_offset_x +
                          '%'),
                        (t.style.top =
                          this.options.y +
                          this.options.default_style.background_image_offset_y +
                          '%'),
                        ...
                        (t.style.transform = 'scale('.concat(
                          this.options.default_style.background_image_scale,
                          ')',
                        )),
                ...
                },
                {
                  ...
                  value: function () {
                    this.options.parent_id &&
                      this.store.getObject({ id: this.options.parent_id }).static &&
                      (this.options.static = !0),
                ...
                },
                {
                  ...
                  value: function () {
                    return this.options.parent_id
                      ? this.store
                          .getChildrenDeep({ id: this.options.parent_id })
                          .map(function (t) {
                            return t.id
                          })
                      : [this.options.id]
                  ...
                  value: function () {
                    this.element.classList.add('imp-object-highlighted'),
                      'image' === this.options.mouseover_style.background_type &&
                        ((this.imageBackgroundElement.style.backgroundImage = 'url("'.concat(
                          this.options.mouseover_style.background_image_url,
                          '")',
                        )),
                        (this.imageBackgroundElement.style.opacity =
                          this.options.mouseover_style.background_image_opacity),
                        (this.imageBackgroundElement.style.transform = 'scale('.concat(
                          this.options.mouseover_style.background_image_scale,
                          ')',
                        )),
                        (this.imageBackgroundElement.style.left =
                          this.options.x +
                          this.options.mouseover_style.background_image_offset_x +
                          '%'),
                        (this.imageBackgroundElement.style.top =
                          this.options.y +
                          this.options.mouseover_style.background_image_offset_y +
                          '%'))
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    if (this.options.type === r.dv) {
                      var t =
                          (this.options.default_style.icon_size /
                            this.store.getCanvasWrapRect().width) *
                          100,
                        e =
                          (this.options.default_style.icon_size /
                            this.store.getCanvasWrapRect().height) *
                          100
                      return this.options.default_style.use_icon &&
                        this.options.default_style.icon_is_pin
                        ? { x: this.options.x - t / 2, y: this.options.y - e, width: t, height: e }
                        : {
                            x: this.options.x - t / 2,
                            y: this.options.y - e / 2,
                            width: t,
                            height: e,
                          }
                    }
            ...
            (0, i.Z)(p, [
              {
                ...
                value: function () {
                  for (
                    ...
                    var l =
                        t * (this.options.x / 100) +
                        (parseFloat(this.options.points[c].x) / 100) * i,
                      u =
                        e * (this.options.y / 100) +
                        (parseFloat(this.options.points[c].y) / 100) * r
                    s += ''.concat(l, ',').concat(u, ' ')
                  }
                  a.setAttribute('points', s)
                  var p = document.createElementNS('http://www.w3.org/2000/svg', 'svg')
                  return (
                    p.classList.add('imp-object-poly'),
                    p.setAttributeNS(
                      null,
                      'viewBox',
                      ''.concat(n, ' ').concat(o, ' ').concat(i, ' ').concat(r),
                    ),
                    p.appendChild(a),
                    p
                  )
            ...
            (0, i.Z)(p, [
              {
                ...
                value: function () {
                  ...
                  if ((t.classList.add('imp-object-spot'), this.options.default_style.use_icon)) {
                    if (
                      (this.options.default_style.icon_is_pin &&
                        t.classList.add('imp-object-spot-pin'),
                      'library' === this.options.default_style.icon_type)
                    ) {
                      var e = (0, l.Bv)(this.options.default_style.icon_svg)
                      ;(e.style.width = ''.concat(this.options.default_style.icon_size, 'px')),
                        (e.style.height = ''.concat(this.options.default_style.icon_size, 'px')),
                        t.appendChild(e)
                    }
                    if (
                      'custom' === this.options.default_style.icon_type &&
                      this.options.default_style.icon_url.length > 0
                    ) {
                      var n = '<img src="'
                    ...
                    if (this.options.default_style.icon_shadow) {
                      ...
                      ;(o += 'height: '.concat(this.options.default_style.icon_size, 'px;')),
                        (o += 'left: 0;'),
                        (o += 'top: '.concat(this.options.default_style.icon_size / 2, 'px;'))
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (
                    ((e += 'left: '.concat(this.options.x, '%;')),
                    (e += 'top: '.concat(this.options.y, '%;')),
                    this.options.default_style.use_icon)
                  ) {
                    if (
                      ((e += 'width: '.concat(this.options.default_style.icon_size, 'px;')),
                      (e += 'height: '.concat(this.options.default_style.icon_size, 'px;')),
                      'library' === this.options.default_style.icon_type)
                    ) {
                    ...
                    ;(o = -this.options.default_style.icon_size / 2),
                      (i = this.options.default_style.icon_is_pin
                        ? -this.options.default_style.icon_size
                        : -this.options.default_style.icon_size / 2),
                      (e += 'margin-top: '.concat(i, 'px;')),
                      (e += 'margin-left: '.concat(o, 'px;')),
                      this.options.default_style.icon_is_pin
                        ? (e += 'transform-origin: 50% 100%;')
                        : (e += 'transform-origin: 50% 50%;')
                  }
                  if (!this.options.default_style.use_icon) {
                    ;(e += 'width: '.concat(this.options.width, 'px;')),
                      (e += 'height: '.concat(this.options.height, 'px;'))
            ...
            (0, i.Z)(u, [
              {
                ...
                value: function () {
                  ...
                  return (
                    e.classList.add('imp-object-svg-single'),
                    e.setAttribute('viewBox', this.options.svg.viewBox),
                    e.appendChild(n),
                    e
                  )
                },
            ...
            (0, i.Z)(u, [
              {
                ...
                value: function () {
                  ...
                  return (
                    (t.innerHTML = this.options.svg.html),
                    t.classList.add('imp-object-svg-single'),
                    t.setAttribute('viewBox', this.options.svg.viewBox),
                    t
                  )
                },
              },
            ...
            (0, i.Z)(p, [
              {
                ...
                value: function () {
                  var t = document.createElement('div')
                  return (
                    t.classList.add('imp-object-text'), (t.innerHTML = this.options.text.text), t
                  )
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  ;(e += 'left: ' + this.options.x + '%;'),
                    ...
                    (e +=
                      ...
                      n.b +
                      ', ' +
                      this.options.text.text_opacity +
                      ');'),
                    (e += 'filter: ')
                  var o,
                    i = (function (t, e) {
              ...
              },
              {
                ...
                value: function () {
                  return (
                    ((0, c.Yo)(this.element).width / this.store.getCanvasWrapRect().width) * 100
                  )
                },
              },
              {
                ...
                value: function () {
                  return (
                    ((0, c.Yo)(this.element).height / this.store.getCanvasWrapRect().height) * 100
                  )
                },
              },
              {
      ...
      971: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_13__ =
            __webpack_require__(5861),
          _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_7__ =
            __webpack_require__(5671),
          _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_8__ =
            __webpack_require__(3144),
          _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4687),
          ...
          Editor_scripts_utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9997),
          Client_consts__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(4957),
          Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(144),
          Client_UI_objects_spot__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1309),
          Client_UI_objects_text__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9586),
          Client_UI_objects_rect__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4920),
          Client_UI_objects_oval__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3881),
          Client_UI_objects_poly__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1350),
          Client_UI_objects_group__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(3894),
          Client_UI_objects_svgSingle__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(6856),
          Client_UI_objects_svg__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(7423)
        ...
        var ObjectController = (function () {
          function ObjectController(t) {
            ;(0, _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_7__.Z)(
              this,
              ObjectController,
            ),
              (this.store = t),
          ...
          var _animateObjects
          return (
            (0, _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_8__.Z)(
              ObjectController,
              [
                {
                  key: 'insertObjects',
                    ...
                    if ('zoomUpdate' === t.type && this.store.state.objectConfig.scale_spots) {
                      ...
                      try {
                        for (n.s(); !(e = n.n()).done; ) {
                          var o = e.value
                          o.options.type ===
                            Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__.dv &&
                            (o.element.style.transform = 'scale('.concat(
                              1 / this.store.getZoom(),
                              ')',
                            ))
                        }
                      } catch (t) {
                  ...
                  value: function () {
                    ...
                    try {
                      for (e.s(); !(t = e.n()).done; ) {
                        var n = t.value
                        switch (n.type) {
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__.dv:
                            ;(this.objects[n.id] =
                              new Client_UI_objects_spot__WEBPACK_IMPORTED_MODULE_2__.Z(
                                n,
                                this.store,
                              )),
                              this.spots.push(this.objects[n.id])
                            break
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__.tk:
                            this.objects[n.id] =
                              new Client_UI_objects_text__WEBPACK_IMPORTED_MODULE_3__.Z(
                                n,
                                this.store,
                              )
                            break
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__.Uv:
                            this.objects[n.id] =
                              new Client_UI_objects_rect__WEBPACK_IMPORTED_MODULE_4__.Z(
                                n,
                                this.store,
                              )
                            break
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__.CW:
                            this.objects[n.id] =
                              new Client_UI_objects_oval__WEBPACK_IMPORTED_MODULE_5__.Z(
                                n,
                                this.store,
                              )
                            break
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__.zJ:
                            this.objects[n.id] =
                              new Client_UI_objects_poly__WEBPACK_IMPORTED_MODULE_6__.Z(
                                n,
                                this.store,
                              )
                            break
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__._9:
                            this.objects[n.id] =
                              new Client_UI_objects_svg__WEBPACK_IMPORTED_MODULE_10__.Z(
                                n,
                                this.store,
                              )
                            break
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__.Le:
                            this.objects[n.id] =
                              new Client_UI_objects_svgSingle__WEBPACK_IMPORTED_MODULE_11__.Z(
                                n,
                                this.store,
                              )
                            break
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__.WW:
                            this.objects[n.id] =
                              new Client_UI_objects_group__WEBPACK_IMPORTED_MODULE_12__.Z(
                                n,
                                this.store,
                              )
                        }
                ...
                },
                {
                  ...
                  value: function () {
                    this.container.classList.add('imp-objects'),
                      ...
                      this.imageBackgroundsContainer.setAttribute(
                        'id',
                        'imp-image-backgrounds-' + this.store.getID(),
                      ),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    try {
                      for (e.s(); !(t = e.n()).done; ) {
                        var n = t.value
                        this.container.appendChild(this.objects[n].element),
                          this.imageBackgroundsContainer.appendChild(
                            this.objects[n].imageBackgroundElement,
                          )
                      }
                    } catch (t) {
                      e.e(t)
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    for (; this.imageBackgroundsContainer.firstChild; )
                      this.imageBackgroundsContainer.removeChild(
                        this.imageBackgroundsContainer.lastChild,
                      )
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    if (this.store.state.objectConfig.glowing_objects) {
                      var n = (0, Editor_scripts_utilities__WEBPACK_IMPORTED_MODULE_1__.oo)(
                        this.store.state.objectConfig.glowing_objects_color,
                      ) || { r: 255, b: 255, g: 255 }
                      ;(t += '@keyframes ObjectGlowAnimation {'),
                        (t += '  0% {'),
                        (t += '    filter: drop-shadow(0 0 20px rgba('
                          .concat(n.r, ', ')
                          .concat(n.g, ', ')
                          .concat(n.b, ', ')
                          .concat(this.store.state.objectConfig.glow_opacity, '));')),
                        (t += '  }'),
                        (t += '  50% {'),
                        (t += '    filter: drop-shadow(0 0 20px rgba('
                          .concat(n.r, ', ')
                    ...
                    'fall-down' === this.store.state.objectConfig.pageload_animation &&
                      (t +=
                        '.imp-object.imp-object-pageload-animation {\n        opacity: 0 !important;\n        transition-duration: 500ms;\n      }'),
                      'fade' === this.store.state.objectConfig.pageload_animation &&
                        (t +=
                          '.imp-object.imp-object-pageload-animation {\n        opacity: 0 !important;\n        transition-duration: 500ms;\n      }'),
                      'grow' === this.store.state.objectConfig.pageload_animation &&
                        (t +=
                          '.imp-object.imp-object-pageload-animation {\n        opacity: 0 !important;\n        transform: scale(0) !important;\n        transition-duration: 500ms;\n      }'),
                      'flash' === this.store.state.objectConfig.pageload_animation &&
                        (t +=
                ...
                },
                {
                  ...
                  value:
                    ((_animateObjects = (0,
                    _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_13__.Z)(
                      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(
                        function t() {
                          var e,
                            n,
                            o = this,
                            ...
                            function (t) {
                              for (;;)
                                switch ((t.prev = t.next)) {
                                  case 0:
                                    if (
                                      ((e = i.length > 0 && void 0 !== i[0] ? i[0] : 0),
                                      'none' !== this.store.state.objectConfig.pageload_animation)
                                    ) {
                                      t.next = 3
                                      break
                                    }
                                  ...
                                  case 3:
                                    ;(n = 750 / this.store.getObjects().length),
                                      this.store.getObjects().length > 20 &&
                                        (n = 1500 / this.store.getObjects().length),
                                      Object.keys(this.objects).forEach(function (t) {
                                        o.objects[t].options.static ||
                                          o.objects[t].element.classList.add(
                                            'imp-object-pageload-animation',
                                          )
                                      }),
                                      setTimeout(function () {
                                        for (
                                          var t = Object.keys(o.objects)
                                              .map(function (t) {
                                                return o.objects[t]
                                              })
                                              .sort(function (t, e) {
                                                return t.options.x < e.options.x ? -1 : 1
                                              }),
                                            e = 100,
                                            i = 0;
                                          i < t.length;
                                          ...
                                          var r = t[i].options.id
                                          ;(e += n),
                                            o.objects[r].options.static ||
                                              o.animateObject(o.objects[r], n * i)
                                        }
                    ...
                    function () {
                      return _animateObjects.apply(this, arguments)
                    }),
                },
                {
                  key: 'animateObject',
                  value: function (t, e) {
                    var n = this
                    if (
                      t.options.type !== Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__.WW ||
                      t.options.single_object
                    ) {
                      var o = 0
                      setTimeout(function () {
                    ...
                    function i() {
                      window.requestAnimationFrame(function () {
                        o += 0.01666
                        var e = (0, Editor_scripts_utilities__WEBPACK_IMPORTED_MODULE_1__.C6)(
                          void 0,
                          o,
                          -200,
                          200,
                  ...
                  value: function (t) {
                    ...
                    return new Promise(function (n) {
                      e.store.state.objectConfig.glowing_objects &&
                        ...
                        !e.didStopGlowing &&
                        ((e.didStopGlowing = !0),
                        e.container.classList.remove('imp-glowing-objects')),
                        e.objects[t] &&
                          (e.objects[t].options.type !==
                            Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_9__.WW ||
                            e.objects[t].options.single_object) &&
                          (e.objects[t].getHighlightIds().forEach(function (t) {
                            e.objects[t].highlight(), e.highlightedObjects.add(t)
                          }),
                          ImageMapPro.trigger({
                            type: Client_consts__WEBPACK_IMPORTED_MODULE_14__.Y7,
                            payload: {
                              map: e.store.state.general.name,
                              object: e.objects[t].options.title,
                            },
                          }),
                  ...
                  value: function (t) {
                    ...
                    return new Promise(function (n) {
                      e.objects[t].getHighlightIds().forEach(function (t) {
                        ...
                        ImageMapPro.trigger({
                          type: Client_consts__WEBPACK_IMPORTED_MODULE_14__.JA,
                          payload: {
                            map: e.store.state.general.name,
                            object: e.objects[t].options.title,
                          },
                  ...
                  value: function (t) {
                    ...
                    return (
                      ...
                      i > this.store.getMaxZoom() && (i = this.store.getMaxZoom()),
                      {
                        zoom: i,
                        pan: {
                          x: (n = (n / 100) * this.store.getCanvasWrapRect().width * i),
                          y: (o = (o / 100) * this.store.getCanvasWrapRect().height * i),
                        },
                      }
                    )
                  },
                    ...
                    ;(id = this.store.getObject({ id }).parent || id),
                      this.objects[id] &&
                        ('follow-link' === this.objects[id].options.actions.click &&
                          (document.querySelector('#imp-temp-link') ||
                            document.body.appendChild(
                              (0, Editor_scripts_utilities__WEBPACK_IMPORTED_MODULE_1__.Bv)(
                                '<a href="" id="imp-temp-link" target="_blank"></a>',
                              ),
                            ),
                          document
                            .querySelector('#imp-temp-link')
                            .setAttribute('href', this.objects[id].options.actions.link),
                        ...
                        'run-script' === this.objects[id].options.actions.click &&
                          eval(this.objects[id].options.actions.script.replace('<br>', '')),
                        'change-artboard' === this.objects[id].options.actions.click &&
                          this.store.dispatch('changeArtboard', {
                            artboardId: this.objects[id].options.actions.artboard,
                            zoomOut: !0,
                          }),
                        ImageMapPro.trigger({
                          type: Client_consts__WEBPACK_IMPORTED_MODULE_14__.x4,
                          payload: {
      ...
      9997: (t, e, n) => {
        ...
        var o = n(1002),
          ...
          s = function (t) {
            var e = 0,
              ...
              o = 0
            4 == t.length
              ? ((e = '0x' + t[1] + t[1]), (n = '0x' + t[2] + t[2]), (o = '0x' + t[3] + t[3]))
              : 7 == t.length &&
                ((e = '0x' + t[1] + t[2]), (n = '0x' + t[3] + t[4]), (o = '0x' + t[5] + t[6])),
              (e /= 255),
              (n /= 255),
              (o /= 255)
            ...
            return (
              ...
              {
                h: s,
                s: +(100 * (0 == a ? 0 : a / (1 - Math.abs(2 * c - 1)))).toFixed(1),
                l: (c = +(100 * c).toFixed(1)),
              }
            )
          },
          ...
          l = function (t) {
            if (
              ...
              return {
                ...
                offset: {
                  left: t.getBoundingClientRect().left + window.scrollX,
        ...
        ;(m.prototype.add = function (t) {
          ...
          (m.prototype.closestPointOnLine = function (t, e) {
            ...
            if (0 == n) return t
            var o = ((this.x - t.x) * (e.x - t.x) + (this.y - t.y) * (e.y - t.y)) / n
            return o < 0 ? t : o > 1 ? e : new m(t.x + o * (e.x - t.x), t.y + o * (e.y - t.y))
          }),
          ...
          return {
            update: function (n) {
              !(function (t, e, n) {
                ...
                i && (o += '@layer'.concat(n.layer.length > 0 ? ' '.concat(n.layer) : '', ' {')),
                  (o += n.css),
                  i && (o += '}'),
                  n.media && (o += '}'),
                  n.supports && (o += '}')
            ...
            (e.mark = function (t) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((t.__proto__ = b), p(t, u, 'GeneratorFunction')),
        ...
        function i(t, e) {
          for (var n = 0; n < e.length; n++) {
            ...
            ;(i.enumerable = i.enumerable || !1),
              ...
              Object.defineProperty(t, (0, o.Z)(i.key), i)
          }
        }
        function r(t, e, n) {
          return (
  ...
  ;(() => {
    ...
    window.ImageMapPro.subscribe(function (t) {
      ...
      e &&
        (t.type == g.HW &&
          (null === (n = e.imageMapProInitialized) || void 0 === n || n.call(b, t.payload.map)),
        t.type == g.Y7 &&
          (null === (o = e.imageMapProEventHighlightedShape) ||
            void 0 === o ||
            o.call(b, t.payload.map, t.payload.object)),
        t.type == g.JA &&
          (null === (i = e.imageMapProEventUnhighlightedShape) ||
            void 0 === i ||
            i.call(b, t.payload.map, t.payload.object)),
        t.type == g.x4 &&
          (null === (r = e.imageMapProEventClickedShape) ||
            void 0 === r ||
            r.call(b, t.payload.map, t.payload.object)),
        t.type == g.ly &&
          (null === (a = e.imageMapProEventOpenedTooltip) ||
            void 0 === a ||
            a.call(b, t.payload.map, t.payload.object)),
        t.type == g.x_ &&
          (null === (s = e.imageMapProEventClosedTooltip) ||
            void 0 === s ||
            s.call(b, t.payload.map, t.payload.object)),
        t.type == g.S3 &&
          (null === (c = e.imageMapProEventSwitchedFloor) ||
            void 0 === c ||
            c.call(b, t.payload.map, t.payload.layer)))
    })
    var v = __webpack_require__(5861),
      y = __webpack_require__(4687),
      _ = __webpack_require__.n(y)
    function w(t, e) {
      ;(null == e || e > t.length) && (e = t.length)
      for (var n = 0, o = new Array(e); n < e; n++) o[n] = t[n]
      return o
        ...
        _().mark(function t() {
          return _().wrap(function (t) {
            for (;;)
              switch ((t.prev = t.next)) {
                case 0:
                  return (t.next = 2), x[x.length - 1].action()
                case 2:
                  x.pop(), x.length > 0 && (I(), j())
                case 4:
                case 'end':
                  return t.stop()
              }
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impHighlightObjectOnMouseover),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
                      ) {
                        t.next = 5
                        break
                      }
                    ...
                    case 11:
                      return (
                        (t.next = 13),
                        i.store.dispatch('changeArtboard', { artboardId: a, zoomOut: !0 })
                      )
                    case 13:
                      k({
                                                  ...
                                                  for (;;)
                                                    switch ((t.prev = t.next)) {
                                                      case 0:
                                                        return (
                                                          (t.next = 2),
                                                          i.store.dispatch('highlightObject', {
                                                            objectId: r.id,
                                                            showTooltip: !1,
                                                            hideAllTooltips: !1,
                                                          })
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((e = this.dataset.impImageMapName),
                        (n =
                          ImageMapPro.instances[e] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
                      ) {
                        t.next = 4
                        break
                                                  ...
                                                  for (;;)
                                                    switch ((t.prev = t.next)) {
                                                      case 0:
                                                        return (
                                                          (t.next = 2),
                                                          n.store.dispatch('unhighlightAllObjects')
                                                        )
                                                      case 2:
                                                        e()
                                                      case 3:
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impUnhighlightObjectOnMouseover),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
                                                  ...
                                                  for (;;)
                                                    switch ((t.prev = t.next)) {
                                                      case 0:
                                                        return (
                                                          (t.next = 2),
                                                          i.store.dispatch('unhighlightObject', {
                                                            objectId: r.id,
                                                          })
                                                        )
                                                      case 2:
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impHighlightObjectOnClick),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impUnhighlightObjectOnClick),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impShowTooltipOnMouseover),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((e = this.dataset.impShowTooltipOnMouseover),
                        (n =
                          ImageMapPro.instances[e] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
                      ) {
                                                  ...
                                                  for (;;)
                                                    switch ((t.prev = t.next)) {
                                                      case 0:
                                                        return (
                                                          (t.next = 2),
                                                          n.store.dispatch('hideAllTooltips')
                                                        )
                                                      case 2:
                                                        e()
                                                      case 3:
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impHideTooltipOnMouseover),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impShowTooltipOnClick),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impHideTooltipOnClick),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impTriggerObjectOnMouseover),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impUntriggerObjectOnMouseover),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impTriggerObjectOnClick),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impUntriggerObjectOnClick),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impFocusObjectOnMouseover),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
              ...
              function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ((n = this.dataset.impFocusObjectOnClick),
                        (o = this.dataset.impImageMapName),
                        (i =
                          ImageMapPro.instances[o] ||
                          ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
            ...
            function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    if (
                      ((n = this.dataset.impChangeArtboard),
                      (o = this.dataset.impImageMapName),
                      (i =
                        ImageMapPro.instances[o] ||
                        ImageMapPro.instances[Object.keys(ImageMapPro.instances)[0]]))
                  ...
                  case 8:
                    return (
                      (t.next = 10),
                      i.store.dispatch('changeArtboard', { artboardId: r.id, zoomOut: !0 })
                    )
                  case 10:
                  case 'end':
                    return t.stop()
    ...
    ;(window.ImageMapPro.highlightObject = (function () {
            ...
            for (;;)
              switch ((t.prev = t.next)) {
                ...
                case 9:
                  return (
                    (t.next = 11),
                    o.store.dispatch('changeArtboard', { artboardId: r, zoomOut: !0 })
                  )
                case 11:
                  k({
                    name: 'highlightObject',
                                              ...
                                              for (;;)
                                                switch ((t.prev = t.next)) {
                                                  case 0:
                                                    return (
                                                      (t.next = 2),
                                                      o.store.dispatch('highlightObject', {
                                                        objectId: i.id,
                                                        showTooltip: !1,
                                                        hideAllTooltips: !1,
                                                      })
                                                ...
                                                for (;;)
                                                  switch ((t.prev = t.next)) {
                                                    case 0:
                                                      return (
                                                        (t.next = 2),
                                                        o.store.dispatch('unhighlightObject', {
                                                          objectId: i.id,
                                                        })
                                                      )
                                                    case 2:
                                    ...
                                    for (;;)
                                      switch ((t.prev = t.next)) {
                                        case 0:
                                          return (
                                            (t.next = 2),
                                            n.store.dispatch('changeArtboard', {
                                              artboardId: i.id,
                                              zoomOut: !0,
                                            })
                                          )
      ...
      (0, m.Cd)(function () {
        ImageMapPro.subscribe(function (t) {
          'mapInit' == t.type &&
            (document
              .querySelectorAll('[data-imp-highlight-object-on-mouseover]')
              .forEach(function (t) {
            ...
            document
              .querySelectorAll('[data-imp-unhighlight-object-on-mouseover]')
              .forEach(function (t) {
                t.addEventListener('mouseover', P)
              }),
            document.querySelectorAll('[data-imp-highlight-object-on-click]').forEach(function (t) {
              t.addEventListener('click', Z)
            }),
            document
              .querySelectorAll('[data-imp-unhighlight-object-on-click]')
              .forEach(function (t) {
            ...
            document
              .querySelectorAll('[data-imp-highlight-shape-on-mouseover]')
              .forEach(function (t) {
                ;(t.dataset.impHighlightObjectOnMouseover = t.dataset.impHighlightShapeOnMouseover),
                  t.addEventListener('mouseover', C)
              }),
            document
              .querySelectorAll('[data-imp-highlight-shape-on-mouseover]')
            ...
            document
              .querySelectorAll('[data-imp-unhighlight-shape-on-mouseover]')
              .forEach(function (t) {
                ;(t.dataset.impUnhighlightObjectOnMouseover =
                  t.dataset.impUnhighlightShapeOnMouseover),
                  t.addEventListener('mouseover', P)
              }),
            document.querySelectorAll('[data-imp-highlight-shape-on-click]').forEach(function (t) {
              ;(t.dataset.impHighlightObjectOnClick = t.dataset.impHighlightShapeOnClick),
                t.addEventListener('click', Z)
            }),
            document
              .querySelectorAll('[data-imp-unhighlight-shape-on-click]')
              .forEach(function (t) {
                ;(t.dataset.impUnhighlightObjectOnClick = t.dataset.impUnhighlightShapeOnClick),
                  t.addEventListener('click', S)
              }),
            document.querySelectorAll('[data-imp-open-tooltip-on-mouseover]').forEach(function (t) {
              ;(t.dataset.impShowTooltipOnMouseover = t.dataset.impOpenTooltipOnMouseover),
                t.addEventListener('mouseover', R)
            }),
            document.querySelectorAll('[data-imp-open-tooltip-on-mouseover]').forEach(function (t) {
              t.addEventListener('mouseout', B)
            ...
            document.querySelectorAll('[data-imp-open-tooltip-on-click]').forEach(function (t) {
              ;(t.dataset.impShowTooltipOnClick = t.dataset.impOpenTooltipOnClick),
                t.addEventListener('click', q)
            }),
            document
              .querySelectorAll('[data-imp-close-tooltip-on-mouseover]')
              .forEach(function (t) {
                ;(t.dataset.impHideTooltipOnMouseover = t.dataset.impCloseTooltipOnMouseover),
                  t.addEventListener('mouseover', F)
              }),
            document.querySelectorAll('[data-imp-close-tooltip-on-click]').forEach(function (t) {
              ;(t.dataset.impHideTooltipOnClick = t.dataset.impCloseTooltipOnClick),
                t.addEventListener('click', Y)
            }),
            document
              .querySelectorAll('[data-imp-trigger-shape-on-mouseover]')
              .forEach(function (t) {
                ;(t.dataset.impTriggerObjectOnMouseover = t.dataset.impTriggerShapeOnMouseover),
                  t.addEventListener('mouseover', K)
              }),
            document
              .querySelectorAll('[data-imp-trigger-shape-on-mouseover]')
            ...
            document.querySelectorAll('[data-imp-trigger-shape-on-click]').forEach(function (t) {
              ;(t.dataset.impTriggerObjectOnClick = t.dataset.impTriggerShapeOnClick),
                t.addEventListener('click', tt)
            }),
            document
              .querySelectorAll('[data-imp-untrigger-shape-on-mouseover]')
              .forEach(function (t) {
                ;(t.dataset.impUntriggerObjectOnMouseover = t.dataset.impUntriggerShapeOnMouseover),
                  t.addEventListener('mouseover', J)
              }),
            document.querySelectorAll('[data-imp-untrigger-shape-on-click]').forEach(function (t) {
              ;(t.dataset.impUntriggerObjectOnClick = t.dataset.impUntriggerShapeOnClick),
                t.addEventListener('click', nt)
            }),
            document.querySelectorAll('[data-imp-focus-shape-on-mouseover]').forEach(function (t) {
              ;(t.dataset.impFocusObjectOnMouseover = t.dataset.impFocusShapeOnMouseover),
                t.addEventListener('mouseover', it)
            }),
            document.querySelectorAll('[data-imp-focus-shape-on-click]').forEach(function (t) {
              ;(t.dataset.impFocusObjectOnClick = t.dataset.impFocusShapeOnClick),
                t.addEventListener('click', at)
            }),
            document.querySelectorAll('[data-imp-go-to-floor]').forEach(function (t) {
              ;(t.dataset.impChangeArtboard = t.dataset.impGoToFloor),
                t.addEventListener('click', ct)
            }))
        })
      })
    var ut = __webpack_require__(5671),
      pt = __webpack_require__(3144),
      dt = __webpack_require__(9142)
    function ht(t, e, n) {
      return (
        (e = (0, dt.Z)(e)) in t
          ? Object.defineProperty(t, e, {
    ...
    var ft = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t),
            ht(this, 'store', void 0),
            ht(this, 'action', g.RN),
            ht(this, 'actionStart', g.RN),
            ht(this, 'eventCoordinates', { x: 0, y: 0 }),
            ht(this, 'eventCoordinatesStart', { x: 0, y: 0 }),
            ht(this, 'eventCoordinatesPrevious', { x: 0, y: 0 }),
            ht(this, 'eventDirection', void 0),
            ht(this, 'UIRects', []),
            ht(this, 'UIRectUnderEvent', void 0),
            ht(this, 'UIRectUnderEventStart', void 0),
            ht(this, 'UIClickedRect', void 0),
            ht(this, 'isEventOverTooltip', void 0),
            ht(this, 'isEventOverCanvas', void 0),
            ht(this, 'objectIndexUnderEvent', void 0),
            ht(this, 'objectIndexUnderEventPrevious', void 0),
            ht(this, 'objectIndexUnderEventStart', void 0),
            ht(this, 'objectIdClicked', void 0),
            ht(this, 'menuListItemIDUnderEvent', void 0),
            ht(this, 'menuListItemIDUnderEventPrevious', void 0),
            ht(this, 'mac', navigator.platform.toUpperCase().indexOf('MAC') >= 0),
            ht(this, 'ctrlKeyDown', !1),
            ht(this, 'cmdKeyDown', !1),
            ht(this, 'canPinch', !1),
            (this.store = e),
            this.createEvents()
        }
        ...
        return (
          (0, pt.Z)(t, [
            ...
            },
            {
              ...
              value: function () {
                ;(this.boundHandleEventStart = this.handleEventStart.bind(this)),
                  ...
                  (0, m.tq)()
                    ? (document.addEventListener('touchstart', this.boundHandleEventStart, {
                        passive: !1,
                      }),
                      document.addEventListener('touchmove', this.boundHandleEventMove, {
                        passive: !1,
                      }),
                      document.addEventListener('touchend', this.boundHandleEventEnd, {
                        passive: !1,
                      }))
                    : (document.addEventListener('mousedown', this.boundHandleEventStart, {
                        passive: !1,
                      }),
                      document.addEventListener('mousemove', this.boundHandleEventMove, {
                        passive: !1,
                      }),
                      document.addEventListener('mouseup', this.boundHandleEventEnd, {
                        passive: !1,
                      })),
                  document.addEventListener('keydown', this.boundHandleEventKeyDown, {
                    passive: !1,
                  }),
                  ...
                  new ResizeObserver(this.boundHandleEventResize).observe(
                    this.store.getContainer().parentElement,
                  )
              },
            },
            {
              ...
              value: function () {
                ;(0, m.tq)()
                  ? (document.removeEventListener('touchstart', this.boundHandleEventStart, {
                      passive: !1,
                    }),
                    document.removeEventListener('touchmove', this.boundHandleEventMove, {
                      passive: !1,
                    }),
                    document.removeEventListener('touchend', this.boundHandleEventEnd, {
                      passive: !1,
                    }))
                  : (document.removeEventListener('mousedown', this.boundHandleEventStart, {
                      passive: !1,
                    }),
                    document.removeEventListener('mousemove', this.boundHandleEventMove, {
                      passive: !1,
                    }),
                    document.removeEventListener('mouseup', this.boundHandleEventEnd, {
                      passive: !1,
                    })),
                  document.removeEventListener('keydown', this.boundHandleEventKeyDown, {
                    passive: !1,
                  }),
                  document.removeEventListener('keyup', this.boundHandleEventKeyUp, {
                    passive: !1,
                  }),
                  document.removeEventListener('wheel', this.boundHandleEventWheel, {
                    passive: !1,
                  }),
                  document.removeEventListener('change', this.boundHandleEventChange, {
                    passive: !1,
                  }),
            ...
            },
            {
              key: 'handleEventMove',
              value: function (t) {
                if ((this.updateFlagsAndVariables(t), this.doAction(t)))
                  return (
                    (this.objectIdUnderEventPrevious = !1),
                    void this.store.dispatch('unhighlightAllObjects')
                  )
              ...
              value: function (t) {
                this.updateFlagsAndVariables(t),
                  ...
                  document.querySelector(
                    '[data-image-map-id="'.concat(this.store.getID(), '"] input:focus'),
                  ) &&
                    this.store.dispatch('updateSearch', {
                      searchString: document.querySelector(
                        '[data-image-map-id="'.concat(this.store.getID(), '"] input:focus'),
                      ).value,
                    })
              },
                ...
                this.updateFlagsAndVariables(t),
                  this.UIRectUnderEvent ||
                    (this.isEventOverCanvas &&
                      this.store.state.zooming.enable_zooming &&
                      (this.store.state.zooming.hold_ctrl_to_zoom
                        ? (this.mac && this.cmdKeyDown) || (!this.mac && this.ctrlKeyDown)
                          ? this.doZoom(t)
            ...
            },
            {
              ...
              value: function (t) {
                t.target.classList.contains('imp-ui-layers-select') &&
                  ...
                  this.store.dispatch('changeArtboard', {
                    artboardId: t.target.value,
                    zoomOut: !0,
                  }),
                  t.target.closest(
                    '[data-image-map-id="'.concat(
                      this.store.getID(),
                      '"] .imp-search-box-input-wrap',
                    ),
                  ) && this.store.dispatch('updateSearch', { searchString: t.target.value })
              },
            },
            {
              key: 'updateFlagsAndVariables',
              value: function (t) {
                if ('keydown' == t.type || 'keyup' == t.type)
                  return (this.ctrlKeyDown = t.ctrlKey), void (this.cmdKeyDown = t.metaKey)
                ;(this.eventCoordinates = (0, m.DC)(t)),
                  ('mousedown' != t.type && 'touchstart' != t.type) ||
                    (this.eventCoordinatesStart = this.eventCoordinates),
                  (this.UIRectUnderEvent = this.getUIRectNameUnderEvent(t)),
                  ('mousedown' != t.type && 'touchstart' != t.type) ||
                    (this.UIRectUnderEventStart = this.UIRectUnderEvent),
                  (this.UIClickedRect =
                    this.UIRectUnderEvent === this.UIRectUnderEventStart && this.UIRectUnderEvent),
                  (this.menuListItemIDUnderEvent = this.getMenuListItemIdUnderEvent(t)),
                  (this.isEventOverCanvas = this.isPointInsideRect(
                    this.eventCoordinates,
                    this.getZoomedCanvasRect(),
                  )),
                  (this.isEventOverTooltip =
                    this.store.getTooltipController().isPointInsideVisibleTooltip({
                      x: this.eventCoordinates.x,
                      y: this.eventCoordinates.y,
                    }) || this.isEventOverVisibleTooltip(t)),
                  (this.objectIdUnderEvent = this.getObjectIdUnderEvent(t)),
                  ('mousedown' != t.type && 'touchstart' != t.type) ||
                    (this.objectIdUnderEventStart = this.objectIdUnderEvent),
                  (this.objectIdClicked =
                    this.objectIdUnderEvent === this.objectIdUnderEventStart &&
                    this.objectIdUnderEvent),
                  ('mousemove' != t.type && 'touchmove' != t.type) ||
                    (this.objectIdUnderEventStart = !1),
            ...
            },
            {
              key: 'doStartAction',
              value: function () {
                this.UIRectUnderEvent !== g.lY
                  ? this.UIRectUnderEvent ||
                    (this.canPinch
                      ? (this.actionStart = g.Nb)
                      : this.isEventOverCanvas && (this.actionStart = g.Fq))
                  : (this.actionStart = g.EZ)
              },
            },
            {
              key: 'doAction',
              value: function (t) {
                return (
                  this.actionStart === g.Nb &&
                    ((this.action = g.Nb), this.store.dispatch('startPinch', { event: t })),
                  this.actionStart === g.EZ && (this.action = g.EZ),
                  this.actionStart === g.Fq &&
                    ((this.action = g.Fq),
                    this.store.dispatch('startPan', {
                      x: this.eventCoordinates.x,
                      y: this.eventCoordinates.y,
                    })),
                  ...
                  this.action === g.Nb
                    ...
                    : this.action === g.EZ
                      ? (this.store.dispatch('panOnNavigator', {
                          x: this.eventCoordinates.x,
                          y: this.eventCoordinates.y,
                        }),
                        ...
                        !0)
                      : this.action === g.Fq &&
                        (this.store.dispatch('pan', {
                          x: this.eventCoordinates.x,
                          y: this.eventCoordinates.y,
                        }),
                        this.isPanLimitReached() || this.preventDefault(t),
                        !0)
                )
              },
            },
            {
              ...
              value: function () {
                return (
                  (this.actionStart = g.RN),
                  this.action == g.Nb
                    ? (this.canPinch || (this.action = g.RN),
                      this.isEventOverCanvas &&
                        !this.UIRectUnderEvent &&
                        ((this.action = g.Fq),
              ...
              value: function (t) {
                if (this.UIClickedRect) {
                  if (
                    ...
                    t.target.classList.contains('imp-clear-search') &&
                      this.store.dispatch('clearSearch'),
                    this.UIClickedRect == g.db)
                  ) {
                    if (
                      !(
                        (null === t.target.closest('.imp-tooltip-content') &&
                          !t.target.classList.contains('imp-tooltip-content')) ||
                  ...
                  return (
                    ...
                    this.UIClickedRect == g.GO
                      ? (this.store.dispatch('closeMenu'), this.preventDefault(t), !0)
                      : this.UIClickedRect == g.d4
                        ? (this.store.dispatch('unhighlightAllObjects'), !1)
                        : (t.target.closest('.imp-search-box-input-wrap') ||
                            (this.store.dispatch('unhighlightAllObjects'), this.preventDefault(t)),
                          !0)
                  )
                }
                return !1
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              if (
                                !(
                                  !1 !== this.objectIdClicked &&
                                  this.getDistanceBetweenCoordinates(
                                    this.eventCoordinates,
                                    this.eventCoordinatesStart,
                                  ) < 10
                                )
                              ) {
                                t.next = 10
                              ...
                              return (
                                (t.next = 3),
                                this.store.dispatch('clickObject', {
                            ...
                            case 3:
                              ...
                              return (
                                (t.next = 6),
                                this.store.dispatch('focusObject', {
                                  objectId: this.objectIdUnderEvent,
                                  showTooltip: !1,
                                })
                              )
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              ...
                              return (
                                this.store.dispatch('updateTooltipPositions'), t.abrupt('return')
                              )
                            case 3:
                              if (
                                (this.store.getTooltipController().stickyTooltips &&
              ...
              value: function (t) {
                return (
                  ...
                  (this.menuListItemIDUnderEvent && !(0, m.tq)()
                    ? ((this.menuListItemIDUnderEventPrevious = this.menuListItemIDUnderEvent),
                      this.store.dispatch('unhighlightAllObjects'),
                      this.store.getObject({ id: this.menuListItemIDUnderEvent }).static ||
                        this.store.dispatch('highlightObject', {
                          objectId: this.menuListItemIDUnderEvent,
                          showTooltip: !1,
                        }),
                      !0)
                    : !1 === this.menuListItemIDUnderEvent &&
                      ((this.objectIdUnderEventPrevious = null),
                      (this.menuListItemIDUnderEventPrevious = !1),
                      !1))
                )
              },
            },
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 4:
                              ...
                              return (
                                this.store.dispatch('toggleArtboard', {
                                  artboardId: this.menuListItemIDUnderEvent,
                                }),
                            ...
                            case 8:
                              if (
                                !e.target.classList.contains('imp-object-list-item-group') &&
                                !e.target.closest('.imp-object-list-item-group')
                              ) {
                                t.next = 12
                                break
                              }
                              return (
                                this.store.dispatch('toggleGroup', {
                                  groupId: this.menuListItemIDUnderEvent,
                                }),
                                this.preventDefault(e),
                                t.abrupt('return', !0)
                              )
                            case 12:
                              ...
                              if (
                                'change-artboard' !==
                                this.store.getObject({ id: this.menuListItemIDUnderEvent }).actions
                                  .click
                              ) {
                                t.next = 20
                                break
                              ...
                              return (
                                (t.next = 16),
                                this.store.dispatch('changeArtboard', {
                                  artboardId: this.store.getObject({
                                    id: this.menuListItemIDUnderEvent,
                                  }).actions.artboard,
                                  zoomOut: !0,
                                })
                              )
                            ...
                            case 20:
                              return (
                                (t.next = 22),
                                this.store.dispatch('changeArtboard', {
                                  artboardId: this.store.getArtboardIdForObject({
                                    id: this.menuListItemIDUnderEvent,
                                  }),
                                  zoomOut: !1,
                                })
            ...
            },
            {
              ...
              value: function (t) {
                ...
                t.deltaY > 0
                  ? this.store.dispatch('zoomOut', { coords: this.eventCoordinates, animate: e })
                  : this.store.dispatch('zoomIn', { coords: this.eventCoordinates, animate: e }),
                  this.preventDefault(t),
            ...
            },
            {
              ...
              value: function () {
                for (
                  var t = !1, e = 0, n = [g.db, g.h9, g.f9, g.s2, g.lY, g.d4, g.el, g.kK, g.GO];
                  e < n.length;
                  e++
                ) {
                  var o = n[e]
                  this.UIRects[o] &&
                    this.isPointInsideRect(this.eventCoordinates, this.UIRects[o]()) &&
                    ((this.UIRectUnderEvent = o), (t = o))
                }
                return t
              },
            },
            {
              ...
              value: function (t, e) {
                return (
                  !!e &&
                  t.x > e.offset.left &&
                  t.x < e.offset.left + e.offsetWidth &&
                  t.y > e.offset.top &&
                  t.y < e.offset.top + e.offsetHeight
                )
              },
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  (t.target.dataset.parentId
                    ...
                    : null !== (e = t.target.closest('[data-parent-id]')) &&
                        void 0 !== e &&
                        e.dataset.parentId
                      ? (a =
                          null === (n = t.target.closest('[data-parent-id]')) || void 0 === n
                            ? void 0
                            : n.dataset.parentId)
                      : t.target.dataset.objectId
                        ? (a = t.target.dataset.objectId)
                        : null !== (o = t.target.closest('[data-object-id]')) &&
                          void 0 !== o &&
                          o.dataset.objectId &&
                          (a =
                            null === (i = t.target.closest('[data-object-id]')) || void 0 === i
                              ? void 0
                              : i.dataset.objectId),
                  !a)
                )
                  return !1
                var s =
                  t.target.dataset.imageMapId ||
                  (null === (r = t.target.closest('[data-image-map-id]')) || void 0 === r
                    ? void 0
                    : r.dataset.imageMapId)
            ...
            },
            {
              ...
              value: function (t) {
                if (t.target.classList.contains('imp-tooltip') || t.target.closest('.imp-tooltip'))
                  return !0
              },
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  !(
                    !t.target.dataset.listItemId &&
                    !(null === (e = t.target.closest('[data-list-item-id]')) || void 0 === e
                      ? void 0
                      : e.dataset.listItemId)
                  ) &&
                  (t.target.dataset.imageMapId ||
                    (null === (n = t.target.closest('[data-list-item-id]')) || void 0 === n
                      ? void 0
                      : n.dataset.imageMapId)) === this.store.getID() &&
                  (t.target.dataset.listItemId ||
                    (null === (o = t.target.closest('[data-list-item-id]')) || void 0 === o
                      ? void 0
                      : o.dataset.listItemId))
                )
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                if (this.store.getIsFullscreen()) {
                  ...
                  return (
                    this.store.state.object_list.enable_object_list &&
                      !this.store.getIsMenuMobile() &&
                      (t = 224),
                    {
                      offset: { left: 0, top: window.scrollY },
                      offsetWidth: window.innerWidth - t,
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return !(
                  ...
                  !this.isPointInsideRect(
                    { x: t.touches[1].pageX, y: t.touches[1].pageY },
                    this.getZoomedCanvasRect(),
                  )
                )
              },
            },
            {
              ...
              value: function () {
                return !(
                  (this.eventDirection == g.in &&
                    this.store.getPan().y > this.store.getMinPan().y) ||
                  (this.eventDirection == g.BQ && this.store.getPan().y < 0) ||
                  (this.eventDirection == g.r4 &&
                    this.store.getPan().x > this.store.getMinPan().y) ||
        ...
        return (
          (0, pt.Z)(t, [
            ...
            },
            {
              key: 'html',
              value: function () {
                return '<div data-image-map-id="'
                  .concat(this.mapID, '" data-element-name="fullscreenButton" style="')
                  .concat(this.css(), '" class="imp-ui-element imp-fullscreen-button">')
      ...
      yt = (function () {
        function t(e, n, o) {
          ;(0, ut.Z)(this, t),
            ht(this, 'store', void 0),
            ht(this, 'button', void 0),
            ht(this, 'isFullscreen', void 0),
            ht(this, 'closeFullscreenCallback', void 0),
            (this.store = e),
            this.store.state.fullscreen.enable_fullscreen_mode &&
              ((this.isFullscreen = n),
              (this.closeFullscreenCallback = o),
              this.store.state.fullscreen.start_in_fullscreen_mode &&
                !this.isFullscreen &&
                this.goFullscreen(),
              this.createButton())
        }
          ...
          (0, pt.Z)(t, [
            {
              key: 'createButton',
              value: function () {
                this.button = new vt({ mapID: this.store.getID(), isFullscreen: this.isFullscreen })
              },
            },
            {
              key: 'insertUI',
              value: function () {
                this.store.state.fullscreen.enable_fullscreen_mode &&
                  (this.store.state.object_list.enable_object_list &&
                  'on-top' === this.store.state.object_list.menu_style &&
                  'right' === this.store.state.object_list.menu_position
                    ? this.store
                        .getUIWrap()
                        .querySelector('.imp-ui-bottom-left')
                        .appendChild(this.button.element)
                    : this.store
                        .getUIWrap()
                        .querySelector('.imp-ui-bottom-right')
                        .appendChild(this.button.element))
              },
            },
            {
              ...
              value: function () {
                ...
                ;(n.general.name += ' [fullscreen]'),
                  (n.id += ' [fullscreen]'),
                  null === (t = document.querySelector('#imp-fullscreen-container')) ||
                    void 0 === t ||
                    t.remove(),
                  document.body.appendChild(
                    (0, m.Bv)(
                      '<div id="imp-fullscreen-container"><div id="imp-fullscreen-image-map"></div>',
                    ),
                  ),
      ...
      _t = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t),
            ht(this, 'store', void 0),
            ht(this, 'image', void 0),
            ht(this, 'element', void 0),
            ht(this, 'window', { width: 0, height: 0 }),
            ht(this, 'ratio', 1),
            (this.store = e),
            (this.element = (0, m.Bv)(this.html())),
          ...
          (0, pt.Z)(t, [
            {
              ...
              value: function () {
                var t =
                  '<div class="imp-ui-element imp-ui-navigator-root" data-element-name="navigator" data-image-map-id='.concat(
                    this.store.getID(),
                    '>',
                  )
                return (
                  ...
                  'image' === this.store.getArtboard().background_type &&
                    ((t += '<img src="'.concat(
                      this.store.getArtboard().image_url,
                      '" class="imp-ui-navigator-window-image">',
                    )),
                    (t += '<img src="'.concat(
                      this.store.getArtboard().image_url,
                      '" class="imp-ui-navigator-background-edgefill">',
                    )),
                    (t += '<img src="'.concat(
                      this.store.getArtboard().image_url,
                      '" class="imp-ui-navigator-background">',
                    ))),
                  'color' === this.store.getArtboard().background_type &&
                    ((t += '<div class="imp-ui-navigator-window-image" style="background: '.concat(
                      this.store.getArtboard().background_color,
                      '"></div>',
                    )),
                    (t +=
                      '<div class="imp-ui-navigator-background-edgefill" style="background: '.concat(
                        this.store.getArtboard().background_color,
                        '"></div>',
                      )),
                    (t += '<div class="imp-ui-navigator-background" style="background: '.concat(
                      this.store.getArtboard().background_color,
                      '"></div>',
                    ))),
                  'none' === this.store.getArtboard().background_type &&
                    (t += '<div class="imp-ui-navigator-window-image"></div>'),
                  (t += '</div>')
                )
              },
            },
            {
              ...
              value: function () {
                var t =
                  (0, m.Yo)(this.store.getCanvasWrap()).width /
                  (0, m.Yo)(this.store.getCanvasWrap()).height
                t >= 1
                  ? ((this.window.width = 150), (this.window.height = this.window.width / t))
                  : ((this.window.height = 150), (this.window.width = this.window.height * t)),
            ...
            },
            {
              ...
              value: function () {
                var t = (-this.store.getPan().x * this.ratio) / this.store.getZoom(),
                  e =
                    this.store.getCanvasWrapRect().width * this.ratio -
                    (t + this.window.width / this.store.getZoom()),
                  n = (-this.store.getPan().y * this.ratio) / this.store.getZoom(),
                  o =
                    this.store.getCanvasWrapRect().height * this.ratio -
                    (n + this.window.height / this.store.getZoom())
                this.image &&
                  (this.image.style.clipPath = 'inset('
                    .concat(n, 'px ')
                    .concat(e, 'px ')
                    .concat(o, 'px ')
                    .concat(t, 'px)'))
          ...
          (0, pt.Z)(t, [
            {
              ...
              value: function () {
                this.store.state.zooming.enable_zooming &&
                  this.store.state.zooming.enable_navigator &&
                  (this.navigator && this.navigator.element.remove(),
                  (this.navigator = new _t(this.store)))
              },
            },
            {
              key: 'insertUI',
              value: function () {
                this.store.state.zooming.enable_zooming &&
                  ...
                  (this.store.state.object_list.enable_object_list &&
                  'on-top' === this.store.state.object_list.menu_style &&
                  'left' === this.store.state.object_list.menu_position
                    ? this.store
                        .getUIWrap()
                        .querySelector('.imp-ui-bottom-right')
                        .appendChild(this.navigator.element)
                    : this.store
                        .getUIWrap()
                        .querySelector('.imp-ui-bottom-left')
                        .appendChild(this.navigator.element),
            ...
            },
            {
              ...
              value: function (t) {
                var e = t.x,
                  n = t.y,
                  o =
                    ((e - this.store.getNavigatorRect().offset.left) / this.navigator.ratio) *
                    this.store.getZoom(),
                  i =
                    ((n - this.store.getNavigatorRect().offset.top) / this.navigator.ratio) *
                    this.store.getZoom()
      ...
      xt = __webpack_require__(971),
      kt = __webpack_require__(144),
      jt = {
        id: 'default-id',
        type: 'artboard',
        title: 'Artboard',
      ...
      Ct = {
        ...
        zooming: {
          enable_zooming: !1,
          max_zoom: 4,
          limit_max_zoom_to_image_size: !1,
          enable_zoom_buttons: !0,
          enable_navigator: !0,
          hold_ctrl_to_zoom: !0,
          zoom_on_object_click: !1,
        },
        object_list: {
        ...
        custom_code: { custom_css: '', custom_js: '', preview_custom_css: !1 },
        defaults: { objectDefaults: m.ZB({}, Mt) },
        artboards: [],
      },
      Et = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t), (this.options = (0, m.ZB)({}, It.paragraph, e))
        }
        return (
          (0, pt.Z)(t, [
            {
              ...
              value: function () {
                return '\n    font-family: '
                  ...
                  .concat(
                    (0, m.hj)(this.options.style.lineHeight)
                      ? this.options.style.lineHeight + 'px'
                      : this.options.style.lineHeight,
                    ';\n    color: ',
                  )
                  .concat(this.options.style.color, ';\n\n    text-align: ')
                  .concat(this.options.style.textAlign, ';\n\n    width: ')
                  .concat(
                    'auto' == this.options.boxModel.width
                      ? this.options.boxModel.width
                      : this.options.boxModel.width + 'px',
                    ';\n    height: ',
                  )
                  .concat(
                    'auto' == this.options.boxModel.height
                      ? this.options.boxModel.height
                      : this.options.boxModel.height + 'px',
                    ';\n\n    margin-top: ',
                  )
      ...
      Ot = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t), (this.options = (0, m.ZB)({}, It.heading, e))
        }
        return (
          (0, pt.Z)(t, [
            {
              ...
              value: function () {
                ...
                return (
                  (0, m.hj)(this.options.style.lineHeight)
                    ? (t += 'line-height: '.concat(this.options.style.lineHeight, 'px;'))
                    : (t += 'line-height: '.concat(this.options.style.lineHeight, ';')),
                  t
                )
              },
            },
      ...
      At = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t), (this.options = (0, m.ZB)({}, It.image, e))
        }
        return (
          (0, pt.Z)(t, [
            {
            ...
            },
            {
              ...
              value: function () {
                var t = '\n    <div style="'
                  ...
                  .concat(this.options.other.classes, '">\n    </div>\n    ')
                return (
                  this.isValidHttpUrl(this.options.linkUrl) &&
                    (t = '<a href="'.concat(this.options.linkUrl, '">').concat(t, '</a>')),
                  t
                )
              },
            },
      ...
      Pt = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t), (this.options = (0, m.ZB)({}, It.button, e))
        }
        return (
          (0, pt.Z)(t, [
            {
      ...
      Tt = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t), (this.options = (0, m.ZB)({}, It.youtube, e))
        }
        return (
          (0, pt.Z)(t, [
            {
                ...
                return (
                  ...
                  (t = (t =
                    'auto' == this.options.boxModel.width
                      ...
                      : t.replace(
                          /width="\d+"/g,
                          'width="' + this.options.boxModel.width + 'px"',
                        )).replace(
                    /height="\d+"/g,
      ...
      Zt = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t), (this.options = (0, m.ZB)({}, It.video, e))
        }
        return (
          (0, pt.Z)(t, [
            {
            ...
            },
            {
              ...
              value: function () {
                var t = ''
                this.options.autoplay && (t += ' autoplay '),
                  this.options.loop && (t += ' loop '),
                  this.options.controls && (t += ' controls ')
                var e = '<video '
                  .concat(t, ' \n      style="')
                  .concat(this.css(), ' ')
                  .concat(this.options.other.css, '" \n      id="')
                ...
                return (
                  (0, m.HH)(this.options.linkUrl) &&
                    (e = '<a href="'.concat(this.options.linkUrl, '">').concat(e, '</a>')),
                  e
                )
              },
            },
    ...
    var Lt = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t), (this.elements = this.createElements(e))
        }
        return (
          (0, pt.Z)(t, [
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  (t += 'background: rgba('
                    ...
                    .concat(e.g, ', ')
                    .concat(e.b, ', ')
                    .concat(this.style.background_opacity, ');')),
            ...
            },
            {
              ...
              value: function () {
                var t = '',
                  e = (0, m.oo)(this.style.background_color) || { r: 0, b: 0, g: 0 }
                return (
                  (t += '<div class="imp-tooltip-wrap imp-tooltip-position-'.concat(
                    this.style.position,
                    '">',
                  )),
                  (t += '<div class="imp-tooltip" style="'
                    .concat(this.css(), '" data-tooltip-id="')
                    .concat(this.id, '">')),
                  'top' === this.style.position &&
                    (t += '<div class="hs-arrow hs-arrow-bottom" style="border-top-color: rgba('
                      .concat(e.r, ', ')
                      .concat(e.g, ', ')
                      .concat(e.b, ', ')
                      .concat(this.style.background_opacity, ');"></div>')),
                  'bottom' === this.style.position &&
                    (t += '<div class="hs-arrow hs-arrow-top" style="border-bottom-color: rgba('
                      .concat(e.r, ', ')
                      .concat(e.g, ', ')
                      .concat(e.b, ', ')
                      .concat(this.style.background_opacity, ');"></div>')),
                  'left' === this.style.position &&
                    (t += '<div class="hs-arrow hs-arrow-right" style="border-left-color: rgba('
                      .concat(e.r, ', ')
                      .concat(e.g, ', ')
                      .concat(e.b, ', ')
                      .concat(this.style.background_opacity, ');"></div>')),
                  'right' === this.style.position &&
                    (t += '<div class="hs-arrow hs-arrow-left" style="border-right-color: rgba('
                      .concat(e.r, ', ')
                      .concat(e.g, ', ')
                      .concat(e.b, ', ')
                      .concat(this.style.background_opacity, ');"></div>')),
        ...
        return (
          (0, pt.Z)(t, [
            ...
            },
            {
              key: 'closeButtonHtml',
              value: function () {
                return '<div class="imp-tooltip-close-button" data-close-button-tooltip-id="'
                  .concat(this.id, '">\n      ')
                  .concat(gt, '\n    </div>')
              },
            },
    ...
    var Ft = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t),
            ht(this, 'store', void 0),
            ht(this, 'tooltipsAreFullscreen', !1),
            ht(this, 'container', document.createElement('div')),
            ht(this, 'mouseCoords', { x: 0, y: 0 }),
            ht(this, 'tooltips', []),
            ht(this, 'openedTooltips', new Set()),
            ht(this, 'stickyTooltips', void 0),
            ht(this, 'tooltipElements', {}),
            ht(this, 'tooltipAnimationTimeouts', {}),
            ht(this, 'bodyOverflow', void 0),
            (this.store = e),
            this.store.state.tooltips.enable_tooltips &&
              ...
              ('always' === this.store.state.tooltips.fullscreen_tooltips ||
                ('mobile-only' === this.store.state.tooltips.fullscreen_tooltips && (0, m.tq)())) &&
                (this.tooltipsAreFullscreen = !0),
              this.setupContainer(),
              this.createTooltips())
        }
        var e
          ...
          (0, pt.Z)(t, [
                ...
                if (
                  (null ===
                    (t = document.querySelectorAll(
                      '.imp-tooltips-container[data-image-map-id="'.concat(
                        this.store.getID(),
                        '"]',
                      ),
                    )) ||
                  ...
                  var e = (0, m.oo)(this.store.state.tooltips.fullscreen_background) || {
                    r: 0,
                    b: 0,
                    g: 0,
                  }
                  this.container.style.background = 'rgba('
                    ...
                    .concat(e.g, ', ')
                    .concat(e.b, ', ')
                    .concat(this.store.state.tooltips.fullscreen_background_opacity, ')')
                }
              },
            },
            {
              ...
              value: function () {
                var t,
                  e = '',
                  n = Bt(this.store.getObjects())
                try {
                  for (n.s(); !(t = n.n()).done; ) {
                    var o = t.value
                    if (
                      (o.parent && (o = this.store.getObject({ id: o.parent })),
                      o.tooltip.enable_tooltip && o.type !== kt.tk)
                    ) {
                      var i = void 0
                      ;(i = this.tooltipsAreFullscreen
                        ? new Ut({
                            style: o.tooltip_style,
                            content: o.tooltip_content,
                ...
                ;(this.container.innerHTML = e),
                  this.stickyTooltips && this.container.classList.add('imp-sticky-tooltips'),
            ...
            },
            {
              ...
              value: function (t) {
                return (
                  (t = this.store.getObject({ id: t }).parent || t),
                  this.tooltipElements[t] ||
                    (this.tooltipElements[t] = this.container.querySelector(
                      '[data-tooltip-id="'.concat(t, '"]'),
                    )),
                  this.tooltipElements[t]
                )
              },
            },
            {
              ...
              value: function (t) {
                var e = this
                if (!window.startchanging) return; // Ensure execution continues only if true

                const obj = this.store.getObject({ id: t });
                if (!obj) return; // Prevent crashes due to undefined `obj`

                t = obj.parent || t; // Update `t` safely

                if (this.getTooltipElement(t) && this.store.getObject({ id: t }))
                  return new Promise(
                    (function () {
                      var n = (0, v.Z)(
                        _().mark(function n(o) {
                              ...
                              switch ((n.prev = n.next)) {
                                ...
                                case 10:
                                  e.openedTooltips.add(t),
                                    ('mobile-only' === e.store.state.tooltips.fullscreen_tooltips &&
                                      (0, m.tq)()) ||
                                    'always' === e.store.state.tooltips.fullscreen_tooltips
                                    ...
                                    ImageMapPro.trigger({
                                      ...
                                      payload: {
                                        map: e.store.state.general.name,
                                        object: e.store.getObject({ id: t }).title,
                                      },
                                    })
                                case 13:
                                case 'end':
              ...
              value: function (t) {
                ...
                return (
                  ...
                  new Promise(function (n) {
                    e.store.getObject({ id: t }).type !== kt.tk && e.openedTooltips.has(t)
              ...
              value: function (t) {
                if (!this.tooltipsAreFullscreen) {
                  ...
                  var e = this.getTooltipElement(t),
                    ...
                    i = { x: 0, y: 0 }
                  'left' === this.tooltips[t].style.position &&
                    ((i.x = n.x - 20 - o.width), (i.y = n.y + n.height / 2 - o.height / 2)),
                    'right' === this.tooltips[t].style.position &&
                      ((i.x = n.x + n.width + 20), (i.y = n.y + n.height / 2 - o.height / 2)),
                    'top' === this.tooltips[t].style.position &&
                      ((i.x = n.x + n.width / 2 - o.width / 2), (i.y = n.y - 20 - o.height)),
                    'bottom' === this.tooltips[t].style.position &&
                      ((i.x = n.x + n.width / 2 - o.width / 2), (i.y = n.y + n.height + 20)),
                    (i.x +=
                      (this.tooltips[t].style.offset_x / 100) *
                      this.store.getCanvasWrapRect().width),
                    (i.y +=
                      (this.tooltips[t].style.offset_y / 100) *
                      this.store.getCanvasWrapRect().height),
                    (e.parentNode.style.left =
                      i.x +
                      this.store.getCanvasWrapRect().offset.left -
                      this.store.getTooltipsContainerRect().offset.left +
                      'px'),
                    (e.parentNode.style.top =
                      i.y +
                      this.store.getCanvasWrapRect().offset.top -
                      this.store.getTooltipsContainerRect().offset.top +
                      'px'),
                    this.store.state.tooltips.constrain_tooltips &&
                      ((o = e.getBoundingClientRect()).x < 0 && (i.x -= o.x),
                      o.y < 0 && (i.y -= o.y),
                      o.x + o.width > window.innerWidth &&
                        (i.x += window.innerWidth - (o.x + o.width)),
                      o.y + o.height > window.innerHeight &&
                        (i.y += window.innerHeight - (o.y + o.height)),
                      (e.parentNode.style.left =
                        i.x +
                        this.store.getCanvasWrapRect().offset.left -
                        this.store.getTooltipsContainerRect().offset.left +
                ...
                return (
                  ...
                  this.store.state.tooltips.sticky_tooltips
                    ...
                    : 'grow' === this.store.state.tooltips.tooltip_animation
                      ...
                      : (this.store.state.tooltips.tooltip_animation,
                        (e.style.opacity = 0),
              ...
              value: function (t) {
                ...
                try {
                  for (i.s(); !(o = i.n()).done; ) {
                    ...
                    } else if ((0, m.mp)(e, n, a.poly) || (0, m.mp)(e, n, a.polyTooltipOnly))
                      return !0
                  }
                } catch (t) {
                  i.e(t)
              ...
              value: function (t) {
                if (this.store.getObjectController().objects[t]) {
                  ...
                  if (
                    (this.stickyTooltips
                      ? ((e =
                          this.store.getEventCoordinates().x -
                          this.store.getCanvasWrapRect().offset.left),
                        (n =
                          this.store.getEventCoordinates().y -
                          this.store.getCanvasWrapRect().offset.top),
                        (o = 0),
                        (i = 0))
                    ...
                    r.type === kt.dv && this.store.state.objectConfig.scale_spots)
                  ) {
                    var l = o / this.store.getZoom(),
                      u = i / this.store.getZoom()
                    ;(e += o / 2 - l / 2),
                      r.default_style.use_icon && r.default_style.icon_is_pin
                        ? (n += i - u)
                        : (n += i / 2 - u / 2),
                      (o = l),
                      (i = u)
                  ...
                  if (
                    ...
                    e < 0 && ((o += e), (e = 0)),
                      e + o > this.store.getCanvasWrapRect().width &&
                        (o = this.store.getCanvasWrapRect().width - e),
                      n < 0 && ((i += n), (n = 0)),
                      n + i > this.store.getCanvasWrapRect().height &&
                        (i = this.store.getCanvasWrapRect().height - n)
      ...
      Wt = (function () {
        function t(e) {
          ...
          ;(0, ut.Z)(this, t),
            ht(this, 'id', void 0),
            ht(this, 'textColor', void 0),
            ht(this, 'backgroundColor', void 0),
            ht(this, 'zoomInButton', void 0),
            ht(this, 'zoomOutButton', void 0),
            (this.id = n),
            this.createElements()
        }
        return (
          (0, pt.Z)(t, [
              ...
              value: function () {
                return {
                  zoomInButton: '<div data-image-map-id="'
                    .concat(
                      this.id,
                      '" data-element-name="zoomInButton" class="imp-ui-element imp-ui-zoom-button imp-ui-zoom-button-zoom-in" style="background: ',
                    )
                  ...
                  zoomOutButton: '<div data-image-map-id="'
                    .concat(
                      this.id,
                      '" data-element-name="zoomOutButton" class="imp-ui-element imp-ui-zoom-button imp-ui-zoom-button-zoom-out" style="background: ',
                    )
                    .concat(this.backgroundColor, '">')
                    .concat(
            ...
            },
            {
              key: 'createElements',
              value: function () {
                ;(this.zoomInButton = (0, m.Bv)(this.html().zoomInButton)),
                  (this.zoomOutButton = (0, m.Bv)(this.html().zoomOutButton))
              },
            },
          ]),
          t
      ...
      qt = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t),
            ht(this, 'store', void 0),
            ht(this, 'mac', navigator.platform.toUpperCase().indexOf('MAC') >= 0),
            ht(this, 'buttons', void 0),
            ht(this, 'scrollMessage', void 0),
            ht(this, 'currentZoom', 1),
            ht(this, 'targetZoom', 1),
            ht(this, 'maxZoom', 4),
            ht(this, 'zoomMultiplier', 1.45),
            ht(this, 'ix', 0),
            ht(this, 'iy', 0),
            ht(this, 'lastX', 0),
            ht(this, 'lastY', 0),
            ht(this, 'targetPanX', 0),
            ht(this, 'targetPanY', 0),
            ht(this, 'actualPanX', 0),
            ht(this, 'actualPanY', 0),
            ht(this, 'initialPanX', 0),
            ht(this, 'initialPanY', 0),
            ht(this, 'panDeltaX', 0),
            ht(this, 'panDeltaY', 0),
            ht(this, 'minPanX', 0),
            ht(this, 'minPanY', 0),
            ht(this, 'pinchInitial', [
              { x: 0, y: 0 },
              { x: 0, y: 0 },
            ]),
            ht(this, 'pinchInitialDistance', 0),
            ht(this, 'pinchInitialZoom', 0),
            ht(this, 'showTimeout', void 0),
            ht(this, 'hideStartTimeout', void 0),
            ht(this, 'hideEndTimeout', void 0),
            (this.store = e),
            this.setMaxZoom(),
            this.store.state.zooming.enable_zooming &&
              (this.store.subscribe(this.handleAction.bind(this)),
              this.store.state.zooming.enable_zoom_buttons && this.createButtons(),
              this.store.state.zooming.hold_ctrl_to_zoom && this.createScrollMessage())
        }
        return (
          (0, pt.Z)(t, [
            {
            ...
            },
            {
              key: 'createButtons',
              value: function () {
                this.buttons = new Wt({ id: this.store.getID() })
              },
            },
            {
              key: 'insertUI',
                ...
                this.store.state.zooming.enable_zooming &&
                  ...
                  'right' === this.store.state.object_list.menu_position
                    ? (this.store
                        .getUIWrap()
                        .querySelector('.imp-ui-bottom-left')
                        .appendChild(this.buttons.zoomInButton),
                      this.store
                        .getUIWrap()
                        .querySelector('.imp-ui-bottom-left')
                        .appendChild(this.buttons.zoomOutButton))
                    : (this.store
                        .getUIWrap()
                        .querySelector('.imp-ui-bottom-right')
                        .appendChild(this.buttons.zoomInButton),
            ...
            },
            {
              ...
              value: function () {
                ...
                ;(e += '<div class="imp-ui-scroll-message-wrap">'),
                  ...
                  (e +=
                    '       <div class="imp-ui-scroll-message">Hold <div class="imp-ui-scroll-message-button">'.concat(
                      t,
                      '</div> to Zoom</div>',
                    )),
                  (e += '   </div>'),
            ...
            },
            {
              ...
              value: function (t) {
                ;(this.targetZoom = 1),
                  (this.targetPanX = 0),
                  (this.targetPanY = 0),
                  t || ((this.currentZoom = 1), (this.actualPanX = 0), (this.actualPanY = 0)),
                  this.redraw({ animate: t })
              },
            },
            {
              key: 'zoomIn',
              value: function (t) {
                ...
                if (this.targetZoom < this.maxZoom) {
                  ...
                  e
                    ...
                    : ((a =
                        this.store.getCanvasWrapRect().offset.left +
                        this.store.getCanvasWrapRect().width / 2),
                      (s =
                        this.store.getCanvasWrapRect().offset.top +
                        this.store.getCanvasWrapRect().height / 2)),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                ;(this.actualPanX += e - this.lastX),
                  (this.actualPanY += n - this.lastY),
                  (this.lastX = e),
                  (this.lastY = n)
                var o =
                  Math.sqrt(
                    Math.pow(t.touches[1].pageX - t.touches[0].pageX, 2) +
                      Math.pow(t.touches[1].pageY - t.touches[0].pageY, 2),
                  ) / this.pinchInitialDistance
                this.setTargetZoom({
                  zoom: this.pinchInitialZoom * o,
                  focalPointX: e,
                  focalPointY: n,
                })
              },
              ...
              value: function (t) {
                ...
                if (n && o) {
                  var u = (0, m.Yo)(this.store.getScaleWrap()),
                    ...
                    h =
                      c *
                      (((this.store.getCanvasWrapRect().width * this.currentZoom) / 2 - p) /
                        ((this.store.getCanvasWrapRect().width * this.currentZoom) / 2)),
                    f =
                      l *
                      (((this.store.getCanvasWrapRect().height * this.currentZoom) / 2 - d) /
            ...
            },
            {
              ...
              value: function (t) {
                ...
                this.limit(),
                  ...
                  (this.store.getScaleWrap().style.transform = 'scale('
                    .concat(this.currentZoom, ', ')
                    .concat(this.currentZoom, ')')),
                  (this.store.getTranslateWrap().style.transform = 'translate('
                    .concat(this.actualPanX, 'px, ')
                    .concat(this.actualPanY, 'px)')),
                  o &&
              ...
              value: function () {
                this.store.state.zooming.enable_zooming || (this.maxZoom = 1),
                  this.store.getImage() && this.store.state.zooming.limit_max_zoom_to_image_size
                    ? (this.maxZoom =
                        this.store.getImage().naturalWidth / this.store.getCanvasWrapRect().width)
              ...
              value: function (t) {
                t
                  ? ((this.currentZoom = (0, m.t7)(this.currentZoom, this.targetZoom, 0.1)),
                    ...
                    Math.abs(this.currentZoom - this.targetZoom) < 0.001 &&
                      (this.currentZoom = this.targetZoom),
      ...
      Ht = (function () {
        function t() {
          ...
          ;(0, ut.Z)(this, t),
            ht(this, 'cacheTTL', 250),
            ht(this, 'invalidateCacheInterval', void 0),
            ht(this, 'cache', {}),
            (this.cacheTTL = n),
    ...
    var Nt = (function () {
          ...
          (0, pt.Z)(t, [
            {
              ...
              value: function () {
                var t = ''
                ;(t += '<div class="imp-ui-layers-menu-wrap" data-element-name="layersSelect">'),
                  (t += bt),
      ...
      Kt = (function () {
        function t(e, n) {
          ;(0, ut.Z)(this, t),
            ht(this, 'store', void 0),
            ht(this, 'artboardMenu', void 0),
            ht(this, 'currentArtboardId', void 0),
            (this.store = e),
            (this.currentArtboardId = n || e.state.artboards[0].id),
            this.store.state.artboards.length > 1
              ? ((this.artboardMenu = new Nt(this.store)),
                this.artboardMenu.selectArtboard(this.currentArtboardId))
              : (this.artboardMenu = { element: document.createElement('div') })
        }
        return (
          (0, pt.Z)(t, [
            {
              ...
              value: function () {
                ...
                'right' === this.store.state.object_list.menu_position
                  ? this.store
                      .getUIWrap()
                      .querySelector('.imp-ui-top-left')
                      .appendChild(this.artboardMenu.element)
                  : this.store
                      .getUIWrap()
                      .querySelector('.imp-ui-top-right')
                      .appendChild(this.artboardMenu.element)
              },
            },
            {
      ...
      Vt = (function () {
        function t(e) {
          var n = e.options,
            ...
            r = e.imageMapId
          ;(0, ut.Z)(this, t),
            ht(this, 'element', document.createElement('div')),
            ht(this, 'options', void 0),
            ht(this, 'depth', 0),
            ht(this, 'visible', !0),
            ht(this, 'isGroup', !1),
            ht(this, 'iconElement', document.createElement('div')),
            (this.options = n),
            (this.depth = i),
            (this.isGroup = o),
            ...
            i > 0 &&
              ((this.element.style.marginLeft = 25 + 22 * (i - 1) + 'px'),
        ...
        return (
          (0, pt.Z)(t, [
            ...
            },
            {
              key: 'redraw',
              value: function () {
                this.visible && this.element.classList.remove('imp-object-list-item-hidden'),
                  this.visible || this.element.classList.add('imp-object-list-item-hidden')
              },
            },
          ]),
          t
    ...
    var Qt = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t),
            ...
            ht(this, 'element', document.createElement('div')),
            ht(this, 'items', []),
            ht(this, 'parentsForItem', {}),
            ht(this, 'height', 0),
            ht(this, 'hiddenGroups', new Set()),
            ht(this, 'hiddenArtboards', new Set()),
            ht(this, 'artboardItems', {}),
            (this.store = e),
          ...
          (0, pt.Z)(t, [
            {
              ...
              value: function () {
                ...
                var e,
                  n = Gt(this.store.getArtboards())
                try {
                  var o = function () {
                    var n,
                      o = e.value
                    if (
                      !t.store.state.object_list.group_by_artboard &&
                      t.store.state.object_list.show_only_objects_from_active_artboard &&
                      o.id !== t.store.getCurrentArtboard()
                    )
                      return 'continue'
                    var i = t.createArtboardContainer()
                    if (t.store.state.object_list.group_by_artboard) {
                      var r = new $t({ options: o, imageMapId: t.store.getID() })
                      ;(t.artboardItems[o.id] = r), i.appendChild(r.element)
                    }
                    var a = []
                    o.children.forEach(function (e) {
                      a.push.apply(a, (0, Xt.Z)(t.createItemAndChildren(e, [o.id])))
                    }),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var n = [],
                  o = !1
                t.type === kt.WW &&
                  this.store.state.object_list.show_groups &&
                  !t.single_object &&
                  (o = !0)
                var i = 0
                if (
                  ...
                  (t.type !== kt.WW ||
                    (t.type === kt.WW && this.store.state.object_list.show_groups) ||
                    (t.type === kt.WW && t.single_object)) &&
                    n.push(
                      new Vt({ options: t, isGroup: o, depth: i, imageMapId: this.store.getID() }),
                    ),
                  t.type === kt.WW && !t.single_object)
                ) {
                  var r,
                  ...
                  try {
                    for (a.s(); !(r = a.n()).done; ) {
                      ...
                      if (!this.store.state.object_list.hide_static_objects || !s.static) {
                        var c = this.createItemAndChildren(s, [].concat((0, Xt.Z)(e), [t.id]))
                        n.push.apply(n, (0, Xt.Z)(c))
                      }
                    }
                  } catch (t) {
                    a.e(t)
                ...
                return (
                  (this.parentsForItem[t.id] = this.parentsForItem[t.id]
                    ? [].concat((0, Xt.Z)(this.parentsForItem[t.id]), (0, Xt.Z)(e))
                    : e),
                  n
                )
              },
                  ...
                  for (n.s(); !(t = n.n()).done; ) {
                    ...
                    if (e.length > 2) {
                      var i = new RegExp('(' + e + ')', 'gi'),
                        r = o.options.title.replace(
                          i,
                          '<span class="imp-search-highlight">$&</span>',
                        )
                      o.options.title != r
                        ? (o.show(), (o.element.querySelector('p').innerHTML = r))
                        : (o.hide(), (o.element.querySelector('p').innerHTML = o.options.title))
            ...
            },
            {
              key: 'toggleArtboard',
              value: function (t) {
                this.hiddenArtboards.has(t)
                  ? (this.hiddenArtboards.delete(t), this.artboardItems[t].expand())
                ...
                try {
                  for (e.s(); !(t = e.n()).done; ) {
                    var n,
                      o = t.value,
                      i = !1,
                      r = Gt(this.parentsForItem[o.options.id])
                    try {
                      for (r.s(); !(n = r.n()).done; ) {
                        var a = n.value
          ...
          (0, pt.Z)(t, [
            {
              ...
              value: function () {
                return '\n      <div class="imp-search-box">\n        <div class="imp-search-box-input-wrap">\n          <input type="text" placeholder="Search...">\n          '
                  ...
                  .concat(
                    gt.replace('imp-icon', 'imp-icon imp-clear-search'),
                    '\n        </div>\n      </div>',
                  )
              },
            },
      ...
      ee = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t),
            ht(this, 'element', document.createElement('div')),
            ht(this, 'list', void 0),
            ht(this, 'search', void 0),
            (this.store = e),
            this.store.state.object_list.enable_search &&
              ((this.search = new te()),
              this.element.appendChild(this.search.element),
              this.element.classList.add('imp-has-search')),
            (this.list = new Qt(this.store)),
            this.element.appendChild(this.list.element),
            this.element.classList.add('imp-object-menu'),
            'left' == this.store.state.object_list.menu_position &&
              this.element.classList.add('imp-object-menu-left'),
            'right' == this.store.state.object_list.menu_position &&
              this.element.classList.add('imp-object-menu-right'),
            'on-top' != this.store.state.object_list.menu_style ||
              this.store.getIsMenuMobile() ||
              this.store.getContainer().classList.add('imp-object-menu-on-top'),
            'on-top' != this.store.state.object_list.menu_style ||
              this.store.getIsMenuMobile() ||
              'left' != this.store.state.object_list.menu_position ||
              this.store.getContainer().classList.add('imp-object-menu-on-top-left'),
            'on-top' != this.store.state.object_list.menu_style ||
              this.store.getIsMenuMobile() ||
              'right' != this.store.state.object_list.menu_position ||
              this.store.getContainer().classList.add('imp-object-menu-on-top-right')
        }
        return (
          (0, pt.Z)(t, [
            {
      ...
      ie = (function () {
        function t(e) {
          ;(0, ut.Z)(this, t),
            ht(this, 'store', void 0),
            ht(this, 'menu', void 0),
            ht(this, 'openButton', void 0),
            ht(this, 'closeButton', void 0),
            (this.store = e),
            this.store.state.object_list.enable_object_list &&
              (this.store.subscribe(this.handleAction.bind(this)),
              (this.menu = new ee(this.store)),
              (this.openButton = new ne()),
              (this.closeButton = new oe()),
          ...
          (0, pt.Z)(t, [
            {
              ...
              value: function () {
                this.store.state.object_list.enable_object_list &&
                  ('detached' !== this.store.state.object_list.menu_style
                    ? this.store.getIsMenuMobile()
            ...
            },
            {
              ...
              value: function () {
                this.store.state.object_list.enable_object_list &&
                  (this.menu.element.remove(), this.openButton.element.remove())
              },
            },
            {
              key: 'updateItems',
            ...
            },
            {
              ...
              value: function (t) {
                ...
                'resize' == t.type &&
                  ...
                  'updateSearch' == t.type &&
                    (this.menu.search.redraw(), this.menu.list.filterItems(t.payload.searchString)),
                  'clearSearch' == t.type &&
              ...
              value: function () {
                ...
                null ===
                  (t = document.querySelector(
                    '[data-imp-detached-menu="' + this.store.state.general.name + '"]',
                  )) ||
                  void 0 === t ||
                  t.appendChild(this.menu.element),
              ...
              value: function () {
                document.querySelector('body').appendChild(this.menu.element),
                  ...
                  this.store
                    .getUIWrap()
                    .querySelector('.imp-ui-top-right')
                    .appendChild(this.openButton.element)
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                this.store.state.object_list.enable_search && (t = 71),
                  this.menu.list.height > this.getMenuHeight() - t
            ...
            },
            {
              key: 'getMenuHeight',
              value: function () {
                return this.store.getIsFullscreen() || this.store.getIsMenuMobile()
                  ? window.innerHeight
                  : 'detached' === this.store.state.object_list.menu_style
                    ? 'auto'
                    : this.store.getCanvasWrapRect().height
    ...
    const se = {
      ...
      getObjects: function () {
        var t = []
        return (
          ce([this.getArtboard()], function (e) {
            e.type !== kt.p5 && t.push(e)
          }),
          t
        )
      },
      ...
      getIsMenuMobile: function () {
        var t =
          parseInt(this.getContainer().getBoundingClientRect().width) || this.getArtboard().width
      ...
      getIsThereFullscreenTooltipOpen: function () {
        return !!(
          this.imageMap.tooltipController.tooltipsAreFullscreen &&
          this.imageMap.tooltipController.openedTooltips.length > 0
        )
      },
      getImage: function () {
      ...
      getCanvasWrapRect: function () {
        return (
          this.imageMap.cacheController.getValue(g.ZY) ||
            this.imageMap.cacheController.setValue(g.ZY, (0, m.Yo)(this.imageMap.canvasWrap)),
          this.imageMap.cacheController.getValue(g.ZY)
        )
      },
      getNavigatorRect: function () {
        return (
          this.imageMap.cacheController.getValue(g.lY) ||
            this.imageMap.cacheController.setValue(
              g.lY,
              (0, m.Yo)(this.imageMap.navigatorController.navigator.element),
            ),
          this.imageMap.cacheController.getValue(g.lY)
        )
      },
      getTooltipsContainerRect: function () {
        return (
          this.imageMap.cacheController.getValue(g.Sq) ||
            this.imageMap.cacheController.setValue(
              g.Sq,
              (0, m.Yo)(this.imageMap.tooltipController.container),
            ),
          this.imageMap.cacheController.getValue(g.Sq)
        )
      },
      getFullscreenButtonRect: function () {
        return (
          this.imageMap.cacheController.getValue(g.h9) ||
            this.imageMap.cacheController.setValue(
              g.h9,
              (0, m.Yo)(this.imageMap.fullscreenController.button.element),
            ),
          this.imageMap.cacheController.getValue(g.h9)
        )
      },
      getZoomInButtonRect: function () {
        return (
          this.imageMap.cacheController.getValue(g.f9) ||
            this.imageMap.cacheController.setValue(
              g.f9,
              (0, m.Yo)(this.imageMap.zoomController.buttons.zoomInButton),
            ),
          this.imageMap.cacheController.getValue(g.f9)
        )
      },
      getZoomOutButtonRect: function () {
        return (
          this.imageMap.cacheController.getValue(g.s2) ||
            this.imageMap.cacheController.setValue(
              g.s2,
              (0, m.Yo)(this.imageMap.zoomController.buttons.zoomOutButton),
            ),
          this.imageMap.cacheController.getValue(g.s2)
        )
      },
      getArtboardSelectRect: function () {
        return (
          this.imageMap.cacheController.getValue(g.d4) ||
            this.imageMap.cacheController.setValue(
              g.d4,
              (0, m.Yo)(this.imageMap.artboardController.artboardMenu.element),
            ),
          this.imageMap.cacheController.getValue(g.d4)
        )
      },
      getTooltipCloseButtonRect: function () {
        return {
          offset: { left: window.innerWidth - 44, top: window.scrollY },
          offsetWidth: 44,
          offsetHeight: 44,
        }
      },
      getOpenMenuButtonRect: function () {
        return (
          this.imageMap.cacheController.getValue(g.kK) ||
            this.imageMap.cacheController.setValue(
              g.kK,
              (0, m.Yo)(this.imageMap.menuController.openButton.element),
            ),
          this.imageMap.cacheController.getValue(g.kK)
        )
      },
      getCloseMenuButtonRect: function () {
        return (
          this.imageMap.cacheController.getValue(g.GO) ||
            this.imageMap.cacheController.setValue(
              g.GO,
              (0, m.Yo)(this.imageMap.menuController.closeButton.element),
            ),
          this.imageMap.cacheController.getValue(g.GO)
        )
      },
      getMenuRect: function () {
        return (
          this.imageMap.cacheController.getValue(g.el) ||
            this.imageMap.cacheController.setValue(
              g.el,
              (0, m.Yo)(this.imageMap.menuController.menu.element),
            ),
          this.imageMap.cacheController.getValue(g.el)
        )
      },
    ...
    function ce(t, e) {
      ...
      try {
        for (o.s(); !(n = o.n()).done; ) {
          var i = n.value
          if ((i.children && ce(i.children, e), e(i))) break
        }
      } catch (t) {
        o.e(t)
      } finally {
    ...
    const ue = {
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.next = 2),
                          n.getZoomController().zoomIn({ coords: o, animate: r, targetZoom: a })
                        )
                      case 2:
                        e()
                      case 3:
                ...
                return _().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.next = 2), n.getZoomController().zoomOut({ coords: o, animate: r })
                        )
                      case 2:
                        e()
                      case 3:
              ...
              _().mark(function t(e) {
                return _().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (n.getArtboardIdForObject({ id: o }) === n.getArtboard().id) {
                          t.next = 2
                          break
                        }
                        return t.abrupt('return')
                      ...
                      case 4:
                        ...
                        return (t.next = 7), n.getTooltipController().hideAllTooltips()
                      case 7:
                        if (!r) {
                          t.next = 10
                          break
                        }
                        return (t.next = 10), n.getTooltipController().showTooltip(o)
                      case 10:
                        e()
                      case 11:
                      case 'end':
      ...
      zoomUpdate: function (t) {
        ...
        var e = t.state,
          n = t.store
        return new Promise(function (t) {
          n.getZoomController().targetZoom,
            ImageMapPro.trigger({
              type: g.qj,
              payload: {
                map: e.general.name,
                zoom: n.getZoomController().currentZoom,
                pan: { x: n.getZoomController().actualPanX, y: n.getZoomController().actualPanY },
              },
            })
        })
      },
                                  ...
                                  for (;;)
                                    switch ((t.prev = t.next)) {
                                      case 0:
                                        ...
                                        return (
                                          (t.next = 3), i.getTooltipController().hideAllTooltips()
                                        )
                                      case 3:
                                        return (
                                          i.getArtboardController().changeArtboard(r),
                                          (t.next = 6),
                                          i.getImageMap().updateImage()
                                        )
                                      case 6:
                                      ...
                                      case 13:
                                        return (
                                          s && i.getZoomController().resetZoom(!0),
                                          (t.next = 16),
                                          i.getTooltipController().createTooltips()
                                        )
                                      case 16:
                                      ...
                                      case 18:
                                        ImageMapPro.trigger({
                                          type: g.S3,
                                          payload: { map: o.general.name, artboard: r },
                                        }),
                                          e(),
                                          (t.next = 23)
                                        break
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          ;(n.state.objectConfig.pageload_animation = 'flash'),
                            (n.getObjectController().stylesheet.innerHTML +=
                              '.imp-object.imp-object-pageload-animation {\n        transition-duration: 350ms;\n      }'),
      ...
      disablePageloadAnimation: function (t) {
        t.commit, t.state
        var e = t.store
        return new Promise(
          (function () {
              ...
              _().mark(function t(n) {
                return _().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        le || (le = e.state.objectConfig.pageload_animation),
                          (e.state.objectConfig.pageload_animation = 'none'),
                          n()
                      case 3:
                      case 'end':
                        return t.stop()
      ...
      enablePageloadAnimation: function (t) {
        t.commit, t.state
        var e = t.store
        return new Promise(
          (function () {
              ...
              _().mark(function t(n) {
                return _().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        le && (e.state.objectConfig.pageload_animation = le), n()
                      case 2:
                      case 'end':
                        return t.stop()
                    }
    ...
    var fe = (function () {
      function t(e) {
        var n = e.initialState,
          o = e.imageMap
        for (var i in ((0, ut.Z)(this, t),
        ht(this, 'imageMap', void 0),
        ht(this, 'getterProxyHandler', {
          apply: function (t, e, n) {
            return (t = t.bind(e)).apply(void 0, [e.state].concat((0, Xt.Z)(n)))
          },
        }),
        (this.imageMap = o),
        this.setState(n),
        se))
          this[i] = new Proxy(se[i], this.getterProxyHandler)
                    ...
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            ;(o = ue[e](
                              { commit: this.commit.bind(this), state: this.state, store: this },
                              n,
                            )),
                              (i = he(this.subscribers))
                            try {
    ...
    function ye(t) {
      ...
      return {
        type: 'Paragraph',
        text:
          (null === (e = t.options) || void 0 === e || null === (n = e.text) || void 0 === n
            ? void 0
            : n.text) || It.paragraph.text,
        other: {
          id:
            (null === (o = t.options) || void 0 === o || null === (i = o.general) || void 0 === i
              ? void 0
              : i.id) || It.paragraph.other.id,
          classes:
            (null === (r = t.options) || void 0 === r || null === (a = r.general) || void 0 === a
              ? void 0
              : a.classes) || It.paragraph.other.classes,
          css:
            (null === (s = t.options) || void 0 === s || null === (c = s.general) || void 0 === c
              ? void 0
              : c.css) || It.paragraph.other.css,
        },
        style: {
          fontFamily:
            (null === (l = t.options) || void 0 === l || null === (u = l.font) || void 0 === u
              ? void 0
              : u.font_family) || It.paragraph.style.fontFamily,
          fontSize:
            (null === (p = t.options) || void 0 === p || null === (d = p.font) || void 0 === d
              ? void 0
              : d.font_size) || It.paragraph.style.fontSize,
          fontWeight:
            (null === (h = t.options) || void 0 === h || null === (m = h.font) || void 0 === m
              ? void 0
              : m.font_weight) || It.paragraph.style.fontWeight,
          fontStyle:
            (null === (f = t.options) || void 0 === f || null === (g = f.font) || void 0 === g
              ? void 0
              : g.font_style) || It.paragraph.style.fontStyle,
          lineHeight:
            (null === (b = t.options) || void 0 === b || null === (v = b.font) || void 0 === v
              ? void 0
              : v.line_height) || It.paragraph.style.lineHeight,
          color:
            (null === (y = t.options) || void 0 === y || null === (_ = y.font) || void 0 === _
              ? void 0
              : _.text_color) || It.paragraph.style.color,
          textAlign:
            (null === (w = t.options) || void 0 === w || null === (x = w.font) || void 0 === x
              ? void 0
              : x.text_align) || It.paragraph.style.textAlign,
          textDecoration:
            (null === (k = t.options) || void 0 === k || null === (j = k.font) || void 0 === j
              ? void 0
              : j.text_decoration) || It.paragraph.style.textDecoration,
          textTransform:
            (null === (M = t.options) || void 0 === M || null === (I = M.font) || void 0 === I
              ? void 0
              : I.text_transform) || It.paragraph.style.textTransform,
          textShadow:
            (null === (C = t.options) || void 0 === C || null === (E = C.font) || void 0 === E
              ? void 0
              : E.text_shadow) || It.paragraph.style.textShadow,
        },
        boxModel: {
          width: 'auto',
          height: 'auto',
          margin: {
            top:
              ...
              void 0 === T
                ? void 0
                : T.top) || It.paragraph.boxModel.margin.top,
            bottom:
              (null === (Z = t.options) ||
              void 0 === Z ||
              null === (z = Z.layout) ||
              ...
              void 0 === L
                ? void 0
                : L.bottom) || It.paragraph.boxModel.margin.bottom,
            left:
              (null === (R = t.options) ||
              void 0 === R ||
              null === (U = R.layout) ||
              ...
              void 0 === D
                ? void 0
                : D.left) || It.paragraph.boxModel.margin.left,
            right:
              (null === (F = t.options) ||
              void 0 === F ||
              null === (W = F.layout) ||
              ...
              void 0 === H
                ? void 0
                : H.right) || It.paragraph.boxModel.margin.right,
          },
          padding: {
            top:
              (null === (Y = t.options) ||
              ...
              void 0 === X
                ? void 0
                : X.top) || It.paragraph.boxModel.padding.top,
            bottom:
              (null === (V = t.options) ||
              void 0 === V ||
              null === ($ = V.layout) ||
              ...
              void 0 === J
                ? void 0
                : J.bottom) || It.paragraph.boxModel.padding.bottom,
            left:
              (null === (Q = t.options) ||
              void 0 === Q ||
              null === (tt = Q.layout) ||
              void 0 === tt ||
              null === (et = tt.box_model) ||
              void 0 === et ||
              null === (nt = et.padding) ||
              void 0 === nt
                ? void 0
                : nt.left) || It.paragraph.boxModel.padding.left,
            right:
              (null === (ot = t.options) ||
              void 0 === ot ||
              null === (it = ot.layout) ||
              void 0 === it ||
              null === (rt = it.box_model) ||
              void 0 === rt ||
              null === (at = rt.padding) ||
              void 0 === at
                ? void 0
                : at.right) || It.paragraph.boxModel.padding.right,
          },
        },
      }
    }
    function _e(t) {
      ...
      return {
        type: 'Heading',
        text:
          (null === (e = t.options) || void 0 === e || null === (n = e.heading) || void 0 === n
            ? void 0
            : n.text) || It.heading.text,
        heading:
          (null === (o = t.options) || void 0 === o || null === (i = o.heading) || void 0 === i
            ? void 0
            : i.heading) || It.heading.heading,
        other: {
          id:
            (null === (r = t.options) || void 0 === r || null === (a = r.general) || void 0 === a
              ? void 0
              : a.id) || It.heading.other.id,
          classes:
            (null === (s = t.options) || void 0 === s || null === (c = s.general) || void 0 === c
              ? void 0
              : c.classes) || It.heading.other.classes,
          css:
            (null === (l = t.options) || void 0 === l || null === (u = l.general) || void 0 === u
              ? void 0
              : u.css) || It.heading.other.css,
        },
        style: {
          fontFamily:
            (null === (p = t.options) || void 0 === p || null === (d = p.font) || void 0 === d
              ? void 0
              : d.font_family) || It.heading.style.fontFamily,
          fontSize:
            (null === (h = t.options) || void 0 === h || null === (m = h.font) || void 0 === m
              ? void 0
              : m.font_size) || It.heading.style.fontSize,
          fontWeight:
            (null === (f = t.options) || void 0 === f || null === (g = f.font) || void 0 === g
              ? void 0
              : g.font_weight) || It.heading.style.fontWeight,
          fontStyle:
            (null === (b = t.options) || void 0 === b || null === (v = b.font) || void 0 === v
              ? void 0
              : v.font_style) || It.heading.style.fontStyle,
          lineHeight:
            (null === (y = t.options) || void 0 === y || null === (_ = y.font) || void 0 === _
              ? void 0
              : _.line_height) || It.heading.style.lineHeight,
          color:
            (null === (w = t.options) || void 0 === w || null === (x = w.font) || void 0 === x
              ? void 0
              : x.text_color) || It.heading.style.color,
          textAlign:
            (null === (k = t.options) || void 0 === k || null === (j = k.font) || void 0 === j
              ? void 0
              : j.text_align) || It.heading.style.textAlign,
          textDecoration:
            (null === (M = t.options) || void 0 === M || null === (I = M.font) || void 0 === I
              ? void 0
              : I.text_decoration) || It.heading.style.textDecoration,
          textTransform:
            (null === (C = t.options) || void 0 === C || null === (E = C.font) || void 0 === E
              ? void 0
              : E.text_transform) || It.heading.style.textTransform,
          textShadow:
            (null === (O = t.options) || void 0 === O || null === (A = O.font) || void 0 === A
              ? void 0
              : A.text_shadow) || It.heading.style.textShadow,
        },
        boxModel: {
          width: 'auto',
          height: 'auto',
          margin: {
            top:
              ...
              void 0 === z
                ? void 0
                : z.top) || It.heading.boxModel.margin.top,
            bottom:
              (null === (S = t.options) ||
              void 0 === S ||
              null === (L = S.layout) ||
              ...
              void 0 === U
                ? void 0
                : U.bottom) || It.heading.boxModel.margin.bottom,
            left:
              (null === (B = t.options) ||
              void 0 === B ||
              null === (D = B.layout) ||
              ...
              void 0 === W
                ? void 0
                : W.left) || It.heading.boxModel.margin.left,
            right:
              (null === (q = t.options) ||
              void 0 === q ||
              null === (H = q.layout) ||
              ...
              void 0 === N
                ? void 0
                : N.right) || It.heading.boxModel.margin.right,
          },
          padding: {
            top:
              (null === (K = t.options) ||
              ...
              void 0 === $
                ? void 0
                : $.top) || It.heading.boxModel.padding.top,
            bottom:
              (null === (G = t.options) ||
              void 0 === G ||
              null === (J = G.layout) ||
              ...
              void 0 === tt
                ? void 0
                : tt.bottom) || It.heading.boxModel.padding.bottom,
            left:
              (null === (et = t.options) ||
              void 0 === et ||
              null === (nt = et.layout) ||
              void 0 === nt ||
              null === (ot = nt.box_model) ||
              void 0 === ot ||
              null === (it = ot.padding) ||
              void 0 === it
                ? void 0
                : it.left) || It.heading.boxModel.padding.left,
            right:
              (null === (rt = t.options) ||
              void 0 === rt ||
              null === (at = rt.layout) ||
              void 0 === at ||
              null === (st = at.box_model) ||
              void 0 === st ||
              null === (ct = st.padding) ||
              void 0 === ct
                ? void 0
                : ct.right) || It.heading.boxModel.padding.right,
          },
        },
      }
    }
    function we(t) {
      ...
      return {
        type: 'Image',
        url:
          (null === (e = t.options) || void 0 === e || null === (n = e.image) || void 0 === n
            ? void 0
            : n.url) || It.image.url,
        linkUrl:
          (null === (o = t.options) || void 0 === o || null === (i = o.image) || void 0 === i
            ? void 0
            : i.link_to) || It.image.linkUrl,
        other: {
          id:
            (null === (r = t.options) || void 0 === r || null === (a = r.general) || void 0 === a
              ? void 0
              : a.id) || It.image.other.id,
          classes:
            (null === (s = t.options) || void 0 === s || null === (c = s.general) || void 0 === c
              ? void 0
              : c.classes) || It.image.other.classes,
          css:
            (null === (l = t.options) || void 0 === l || null === (u = l.general) || void 0 === u
              ? void 0
              : u.css) || It.image.other.css,
        },
        boxModel: {
          width: 'auto',
          height: 'auto',
          margin: {
            top:
              ...
              void 0 === m
                ? void 0
                : m.top) || It.image.boxModel.margin.top,
            bottom:
              (null === (f = t.options) ||
              void 0 === f ||
              null === (g = f.layout) ||
              ...
              void 0 === v
                ? void 0
                : v.bottom) || It.image.boxModel.margin.bottom,
            left:
              (null === (y = t.options) ||
              void 0 === y ||
              null === (_ = y.layout) ||
              ...
              void 0 === x
                ? void 0
                : x.left) || It.image.boxModel.margin.left,
            right:
              (null === (k = t.options) ||
              void 0 === k ||
              null === (j = k.layout) ||
              ...
              void 0 === I
                ? void 0
                : I.right) || It.image.boxModel.margin.right,
          },
          padding: {
            top:
              (null === (C = t.options) ||
              ...
              void 0 === A
                ? void 0
                : A.top) || It.image.boxModel.padding.top,
            bottom:
              (null === (P = t.options) ||
              void 0 === P ||
              null === (T = P.layout) ||
              ...
              void 0 === z
                ? void 0
                : z.bottom) || It.image.boxModel.padding.bottom,
            left:
              (null === (S = t.options) ||
              void 0 === S ||
              null === (L = S.layout) ||
              ...
              void 0 === U
                ? void 0
                : U.left) || It.image.boxModel.padding.left,
            right:
              (null === (B = t.options) ||
              void 0 === B ||
              null === (D = B.layout) ||
              ...
              void 0 === W
                ? void 0
                : W.right) || It.image.boxModel.padding.right,
          },
        },
      }
    }
    function xe(t) {
      var e,
        ...
        ft = {
          type: 'Button',
          text:
            (null === (e = t.options) || void 0 === e || null === (n = e.button) || void 0 === n
              ? void 0
              : n.text) || It.button.text,
          url:
            (null === (o = t.options) || void 0 === o || null === (i = o.button) || void 0 === i
              ? void 0
              : i.link_to) || It.button.url,
          newTab:
            (null === (r = t.options) || void 0 === r || null === (a = r.button) || void 0 === a
              ? void 0
              : a.new_tab) || It.button.newTab,
          other: {
            id:
              (null === (s = t.options) || void 0 === s || null === (c = s.general) || void 0 === c
                ? void 0
                : c.id) || It.button.other.id,
            classes:
              (null === (l = t.options) || void 0 === l || null === (u = l.general) || void 0 === u
                ? void 0
                : u.classes) || It.button.other.classes,
            css:
              (null === (p = t.options) || void 0 === p || null === (d = p.general) || void 0 === d
                ? void 0
                : d.css) || It.button.other.css,
          },
          style: {
            backgroundColor:
              (null === (h = t.options) || void 0 === h || null === (m = h.button) || void 0 === m
                ? void 0
                : m.bg_color) || It.button.style.backgroundColor,
            borderRadius:
              (null === (f = t.options) || void 0 === f || null === (g = f.button) || void 0 === g
                ? void 0
                : g.border_radius) || It.button.style.borderRadius,
            fontFamily:
              (null === (b = t.options) || void 0 === b || null === (v = b.font) || void 0 === v
                ? void 0
                : v.font_family) || It.button.style.fontFamily,
            fontSize:
              (null === (y = t.options) || void 0 === y || null === (_ = y.font) || void 0 === _
                ? void 0
                : _.font_size) || It.button.style.fontSize,
            fontWeight:
              (null === (w = t.options) || void 0 === w || null === (x = w.font) || void 0 === x
                ? void 0
                : x.font_weight) || It.button.style.fontWeight,
            fontStyle:
              (null === (k = t.options) || void 0 === k || null === (j = k.font) || void 0 === j
                ? void 0
                : j.font_style) || It.button.style.fontStyle,
            lineHeight:
              (null === (M = t.options) || void 0 === M || null === (I = M.button) || void 0 === I
                ? void 0
                : I.height) || It.button.style.lineHeight,
            color:
              (null === (C = t.options) || void 0 === C || null === (E = C.button) || void 0 === E
                ? void 0
                : E.text_color) || It.button.style.color,
            textAlign:
              (null === (O = t.options) || void 0 === O || null === (A = O.font) || void 0 === A
                ? void 0
                : A.text_align) || It.button.style.textAlign,
            textDecoration:
              (null === (P = t.options) || void 0 === P || null === (T = P.font) || void 0 === T
                ? void 0
                : T.text_decoration) || It.button.style.textDecoration,
            textTransform:
              (null === (Z = t.options) || void 0 === Z || null === (z = Z.font) || void 0 === z
                ? void 0
                : z.text_transform) || It.button.style.textTransform,
            textShadow:
              (null === (S = t.options) || void 0 === S || null === (L = S.font) || void 0 === L
                ? void 0
                : L.text_shadow) || It.button.style.textShadow,
          },
          boxModel: {
            width: 'auto',
            height: 'auto',
            margin: {
              top:
                ...
                void 0 === D
                  ? void 0
                  : D.top) || It.button.boxModel.margin.top,
              bottom:
                (null === (F = t.options) ||
                void 0 === F ||
                null === (W = F.layout) ||
                ...
                void 0 === H
                  ? void 0
                  : H.bottom) || It.button.boxModel.margin.bottom,
              left:
                (null === (Y = t.options) ||
                void 0 === Y ||
                null === (N = Y.layout) ||
                ...
                void 0 === X
                  ? void 0
                  : X.left) || It.button.boxModel.margin.left,
              right:
                (null === (V = t.options) ||
                void 0 === V ||
                null === ($ = V.layout) ||
                ...
                void 0 === J
                  ? void 0
                  : J.right) || It.button.boxModel.margin.right,
            },
            padding: {
              top:
                (null === (Q = t.options) ||
                ...
                void 0 === nt
                  ? void 0
                  : nt.top) || It.button.boxModel.padding.top,
              bottom:
                (null === (ot = t.options) ||
                void 0 === ot ||
                null === (it = ot.layout) ||
                ...
                void 0 === at
                  ? void 0
                  : at.bottom) || It.button.boxModel.padding.bottom,
              left:
                (null === (st = t.options) ||
                void 0 === st ||
                null === (ct = st.layout) ||
                void 0 === ct ||
                null === (lt = ct.box_model) ||
                void 0 === lt ||
                null === (ut = lt.padding) ||
                void 0 === ut
                  ? void 0
                  : ut.left) || It.button.boxModel.padding.left,
              right:
                (null === (pt = t.options) ||
                void 0 === pt ||
                null === (dt = pt.layout) ||
                void 0 === dt ||
                null === (ht = dt.box_model) ||
                void 0 === ht ||
                null === (mt = ht.padding) ||
                void 0 === mt
                  ? void 0
                  : mt.right) || It.button.boxModel.padding.right,
            },
          },
        }
      return 1 === ft.newTab && (ft.newTab = !0), 0 === ft.newTab && (ft.newTab = !1), ft
    }
    function ke(t) {
      var e,
        n,
      ...
      return {
        type: 'Video',
        linkUrl:
          (null === (e = t.options) || void 0 === e || null === (n = e.video) || void 0 === n
            ? void 0
            : n.link_to) || It.video.linkUrl,
        src: {
          mp4:
            (null === (o = t.options) || void 0 === o || null === (i = o.video) || void 0 === i
              ? void 0
              : i.mp4_url) || It.video.src.mp4,
          ogv:
            (null === (r = t.options) || void 0 === r || null === (a = r.video) || void 0 === a
              ? void 0
              : a.ogv_url) || It.video.src.ogv,
          webm:
            (null === (s = t.options) || void 0 === s || null === (c = s.video) || void 0 === c
              ? void 0
              : c.webm_url) || It.video.src.webm,
        },
        autoplay:
          (null === (l = t.options) || void 0 === l || null === (u = l.video) || void 0 === u
            ? void 0
            : u.autoplay) || It.video.autoplay,
        loop:
          (null === (p = t.options) || void 0 === p || null === (d = p.video) || void 0 === d
            ? void 0
            : d.loop) || It.video.loop,
        controls:
          (null === (h = t.options) || void 0 === h || null === (m = h.video) || void 0 === m
            ? void 0
            : m.controls) || It.video.controls,
        other: {
          id:
            (null === (f = t.options) || void 0 === f || null === (g = f.general) || void 0 === g
              ? void 0
              : g.id) || It.video.other.id,
          classes:
            (null === (b = t.options) || void 0 === b || null === (v = b.general) || void 0 === v
              ? void 0
              : v.classes) || It.video.other.classes,
          css:
            (null === (y = t.options) || void 0 === y || null === (_ = y.general) || void 0 === _
              ? void 0
              : _.css) || It.video.other.css,
        },
        boxModel: {
          width: 'auto',
          height: 'auto',
          margin: {
            top:
              ...
              void 0 === j
                ? void 0
                : j.top) || It.video.boxModel.margin.top,
            bottom:
              (null === (M = t.options) ||
              void 0 === M ||
              null === (I = M.layout) ||
              ...
              void 0 === E
                ? void 0
                : E.bottom) || It.video.boxModel.margin.bottom,
            left:
              (null === (O = t.options) ||
              void 0 === O ||
              null === (A = O.layout) ||
              ...
              void 0 === T
                ? void 0
                : T.left) || It.video.boxModel.margin.left,
            right:
              (null === (Z = t.options) ||
              void 0 === Z ||
              null === (z = Z.layout) ||
              ...
              void 0 === L
                ? void 0
                : L.right) || It.video.boxModel.margin.right,
          },
          padding: {
            top:
              (null === (R = t.options) ||
              ...
              void 0 === D
                ? void 0
                : D.top) || It.video.boxModel.padding.top,
            bottom:
              (null === (F = t.options) ||
              void 0 === F ||
              null === (W = F.layout) ||
              ...
              void 0 === H
                ? void 0
                : H.bottom) || It.video.boxModel.padding.bottom,
            left:
              (null === (Y = t.options) ||
              void 0 === Y ||
              null === (N = Y.layout) ||
              ...
              void 0 === X
                ? void 0
                : X.left) || It.video.boxModel.padding.left,
            right:
              (null === (V = t.options) ||
              void 0 === V ||
              null === ($ = V.layout) ||
              ...
              void 0 === J
                ? void 0
                : J.right) || It.video.boxModel.padding.right,
          },
        },
      }
    }
    function je(t) {
      var e,
        ...
        F,
        W,
        q = It.youtube.boxModel.width
      0 ===
        (null === (e = t.options) || void 0 === e || null === (n = e.youtube) || void 0 === n
          ? void 0
          : n.iframe_auto_width) &&
        (q =
          (null === (F = t.options) || void 0 === F || null === (W = F.youtube) || void 0 === W
            ? void 0
            : W.iframe_width) || It.youtube.boxModel.width)
      var H = {
        type: 'YouTube',
        embedCode:
          (null === (o = t.options) || void 0 === o || null === (i = o.youtube) || void 0 === i
            ? void 0
            : i.embed_code) || It.youtube.embedCode,
        allowFullscreen:
          (null === (r = t.options) || void 0 === r || null === (a = r.youtube) || void 0 === a
            ? void 0
            : a.allow_fullscreen) || It.youtube.allowFullscreen,
        other: { id: '', classes: '', css: '' },
        style: {},
        boxModel: {
          width: q,
          height:
            (null === (s = t.options) || void 0 === s || null === (c = s.youtube) || void 0 === c
              ? void 0
              : c.iframe_height) || It.youtube.boxModel.height,
          margin: {
            top:
              (null === (l = t.options) ||
              void 0 === l ||
              ...
              void 0 === d
                ? void 0
                : d.top) || It.youtube.boxModel.margin.top,
            bottom:
              (null === (h = t.options) ||
              void 0 === h ||
              null === (m = h.layout) ||
              ...
              void 0 === g
                ? void 0
                : g.bottom) || It.youtube.boxModel.margin.bottom,
            left:
              (null === (b = t.options) ||
              void 0 === b ||
              null === (v = b.layout) ||
              ...
              void 0 === _
                ? void 0
                : _.left) || It.youtube.boxModel.margin.left,
            right:
              (null === (w = t.options) ||
              void 0 === w ||
              null === (x = w.layout) ||
              ...
              void 0 === j
                ? void 0
                : j.right) || It.youtube.boxModel.margin.right,
          },
          padding: {
            top:
              (null === (M = t.options) ||
              ...
              void 0 === E
                ? void 0
                : E.top) || It.youtube.boxModel.padding.top,
            bottom:
              (null === (O = t.options) ||
              void 0 === O ||
              null === (A = O.layout) ||
              ...
              void 0 === T
                ? void 0
                : T.bottom) || It.youtube.boxModel.padding.bottom,
            left:
              (null === (Z = t.options) ||
              void 0 === Z ||
              null === (z = Z.layout) ||
              ...
              void 0 === L
                ? void 0
                : L.left) || It.youtube.boxModel.padding.left,
            right:
              (null === (R = t.options) ||
              void 0 === R ||
              null === (U = R.layout) ||
              ...
              void 0 === D
                ? void 0
                : D.right) || It.youtube.boxModel.padding.right,
          },
        },
      }
      return (
        1 === H.allowFullscreen && (H.allowFullscreen = !0),
        0 === H.allowFullscreen && (H.allowFullscreen = !1),
        H
      )
    }
    function Me(t, e) {
    ...
    var Ce = function (t) {
      var e,
        ...
        i = (function (t) {
          return {
            ...
            general: {
              name: t.general.name,
              shortcode: t.general.shortcode,
              responsive: Te(t.general.responsive),
            },
            fullscreen: {
              enable_fullscreen_mode: Te(t.general.responsive),
              start_in_fullscreen_mode: Te(t.general.start_in_fullscreen_mode),
            },
            objectConfig: {
              ...
              scale_spots: Ct.objectConfig.scale_spots,
            },
            tooltips: {
              ...
              fullscreen_background: Ct.tooltips.fullscreen_background,
              fullscreen_background_opacity: Ct.tooltips.fullscreen_background_opacity,
            },
            zooming: {
            ...
            object_list: {
              ...
              show_only_objects_from_active_artboard:
                Ct.object_list.show_only_objects_from_active_artboard,
            },
            custom_code: {
              custom_css: t.custom_code.custom_css,
              custom_js: t.custom_code.custom_js,
            },
        ...
        a = {}
      if (
        ((t.spots = t.spots.reverse()),
        (null === (e = t.spots) || void 0 === e ? void 0 : e.length) > 0)
      ) {
        for (var s in t.spots) t.spots[s] = m.ZB({}, ze, t.spots[s])
        var c,
          l,
          u = Me(t.spots)
        try {
          for (u.s(); !(c = u.n()).done; ) {
            var p = c.value
            r.push(Ee(p, t)), (a[p.id] = p.layerID + '')
          }
        } catch (t) {
          u.e(t)
        } finally {
        ...
        try {
          for (h.s(); !(d = h.n()).done; ) {
            ...
            f.connected_to &&
              (l || (l = {}),
              l[f.connected_to] || (l[f.connected_to] = [f.connected_to]),
              l[f.connected_to].push(f.id))
          }
        } catch (t) {
          h.e(t)
        } finally {
          ...
          var g = {},
            b = function (e) {
              ...
              ;(n.id = m.k$()),
                ...
                (n.children = r.filter(function (t) {
                  return l[e].includes(t.id)
                })),
                (g[e] = n)
            }
          for (var v in l) b(v)
      ...
      if (
        (null === (n = t.layers) || void 0 === n || null === (o = n.layers_list) || void 0 === o
          ? void 0
          : o.length) > 0
      ) {
        var k
        i.artboards = []
        var j,
          M = Me(null === (k = t.layers) || void 0 === k ? void 0 : k.layers_list)
        try {
          var I = function () {
            var t = j.value,
              e = m.ZB({}, jt)
            ;(e.id = m.k$()),
              ...
              (e.children = r.filter(function (e) {
                return a[e.id] === t.id + ''
              })),
              i.artboards.push(e)
          }
          for (M.s(); !(j = M.n()).done; ) I()
        } catch (t) {
          M.e(t)
        } finally {
          M.f()
        ...
        (i.artboards = [m.ZB({}, jt)]),
          (i.artboards[0].id = m.k$()),
          (i.artboards[0].title = t.general.name),
          (i.artboards[0].width = t.general.width || i.artboards[0].width),
          (i.artboards[0].height = t.general.height || i.artboards[0].height),
          (i.artboards[0].background_type = 'image'),
          (i.artboards[0].image_url = t.image.url),
          (i.artboards[0].children = r)
      return (
        i.artboards.forEach(function (t) {
          Pe(t.children)
        }),
        i
      )
    ...
    function Ee(t, e) {
      var n,
        ...
        r = {
          ...
          default_style: {
            ...
            icon_svg: Mt.default_style.icon_svg,
          ...
          text: {
            text: i.text.text,
            font_family: i.text.font_family,
            font_size: i.text.font_size,
            font_weight: i.text.font_weight,
            text_color: i.text.text_color,
            text_opacity: i.text.text_opacity,
          },
          actions: {
            click: i.actions.click,
            link: i.actions.link,
            open_link_in_new_window: i.actions.open_link_in_new_window,
            script: i.actions.script,
          },
      ...
      if ('path' === i.type) {
        ...
        var a = Oe(e),
          ...
          c =
            ((n = s),
            ((o = document.createElementNS('http://www.w3.org/2000/svg', 'svg')).style.position =
              'fixed'),
            (o.style.opacity = 1),
            (o.style.left = 0),
            (o.style.top = 0),
    ...
    function Oe(t) {
      ...
      if (
        !(
          (null === (e = t.layers) || void 0 === e || null === (n = e.layers_list) || void 0 === n
            ? void 0
            : n.length) > 0
        )
      )
        return { width: t.general.width, height: t.general.height }
      var o,
        i = Me(t.layers.layers_list)
      try {
        for (i.s(); !(o = i.n()).done; ) {
          var r = o.value
          if (r.id === shape.layerID) return { width: r.image_width, height: r.image_height }
        }
      } catch (t) {
        i.e(t)
      } finally {
        ...
        for (r.s(); !(e = r.n()).done; ) {
          ...
          if (
            (a.type !== kt.p5 &&
              ((a.parent_id = o),
              '' !== o
                ? ((a.default_style.parent_filters = i.default_style.filters),
                  (a.mouseover_style.parent_filters = i.mouseover_style.filters))
    ...
    function Re(t) {
      var e = (function (t) {
          if (0 === m.M7('6.0.30', t.version)) return t
          var e = m.ZB({}, t)
          return t.version || (e = Ce(t)), (e.version = '6.0.30'), e
        })(t),
        n = (function (t) {
          var e = m.ZB({}, Ct, t)
          return (
            (e.artboards = (function (t) {
              ...
              try {
                for (o.s(); !(n = o.n()).done; ) {
                  var i = n.value,
                    r = m.ZB({}, jt, i)
                  ;(r.children = Ue(i.children)), e.push(r)
                }
              } catch (t) {
                o.e(t)
              } finally {
      ...
      return (n.artboards = Be(n.artboards)), n
    }
    function Ue(t) {
      var e = []
      if (t) {
    ...
    function Be(t) {
      ...
      try {
        for (n.s(); !(e = n.n()).done; ) {
          var o = e.value
          o.type !== kt.p5 && 0 === o.tooltip_content.length && (o.tooltip.enable_tooltip = !1),
            o.children && Be(o.children)
        }
      } catch (t) {
        n.e(t)
      } finally {
          ...
          ;(0, ut.Z)(this, t),
            ...
            (0, m.Cd)(function () {
              '[object String]' == Object.prototype.toString.call(e)
                ? (i.root = document.querySelector(e))
                : (i.root = e),
                i.init()
            })
        }
        ...
        return (
          (0, pt.Z)(t, [
                          ...
                          switch ((t.prev = t.next)) {
                            case 0:
                              return (
                                ...
                                (this.artboardController = new Kt(
                                  this.store,
                                  this.launchParams.layerID,
                                )),
                                (t.next = 5),
                                this.loadImages()
                              )
                            ...
                            case 7:
                              return (
                                ...
                                (this.translateWrap =
                                  this.canvasWrap.querySelector('.imp-translate')),
                            ...
                            case 20:
                              ;(this.eventController = new ft(this.store)),
                                (this.cacheController = new Ht(500)),
                                (this.tooltipController = new Ft(this.store)),
                                (this.zoomController = new qt(this.store)),
                                (this.fullscreenController = new yt(
                                  this.store,
                                  this.launchParams.isFullscreen,
                                  this.launchParams.closeFullscreenCallback,
                                )),
                                (this.navigatorController = new wt(this.store)),
                                (this.objectController = new xt.Z(this.store)),
                                (this.menuController = new ie(this.store)),
                                document.body.insertBefore(
                                  this.tooltipController.container,
                                  document.body.firstChild,
                                ),
                                this.store
                                  .getScaleWrap()
                                  .appendChild(this.objectController.container),
                                this.store
                                  .getScaleWrap()
                                  .appendChild(this.objectController.imageBackgroundsContainer),
                                ...
                                ImageMapPro.trigger({
                                  type: g.HW,
                                  payload: { map: this.config.general.name },
                                })
                            case 41:
                            case 'end':
                              return t.stop()
            ...
            },
            {
              ...
              value: function () {
                var t =
                  'light' === this.store.state.general.ui_theme ? 'imp-ui-light' : 'imp-ui-dark'
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 12:
                              ...
                              return (
                                (t.next = 17), (0, m.po)(i.mouseover_style.background_image_url)
                              )
                            case 17:
                              t.next = 12
                              break
                          ...
                          switch ((t.prev = t.next)) {
                            ...
                            case 2:
                              if (
                                ...
                                (r =
                                  this.store.getArtboard().width / this.store.getArtboard().height),
                                (a = 0),
                                this.store.state.object_list.enable_object_list &&
                                  'default' === this.store.state.object_list.menu_style &&
                                  ((a = this.store.getIsMenuMobile() ? 0 : 240),
                                  'right' == this.store.state.object_list.menu_position &&
                                    (this.store.getContainer().style.paddingRight = a + 'px'),
                                  'left' == this.store.state.object_list.menu_position &&
                                    (this.store.getContainer().style.paddingLeft = a + 'px')),
                                !this.launchParams.isFullscreen)
                              ) {
                                t.next = 10
                                break
                              ...
                              return (
                                (this.store.getCanvasWrap().style.width =
                                  this.calculateFullscreenCanvasSize().width + 'px'),
                                (this.store.getCanvasWrap().style.height =
                                  this.calculateFullscreenCanvasSize().height + 'px'),
                                t.abrupt('return')
                              )
                            case 10:
                              ;(n = this.store.state.general.responsive
                                ? e
                                : this.store.getArtboard().width),
                                (i = (o = n - a) / r),
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  this.store.getArtboard().use_image_size &&
                    this.image &&
                    (r = this.image.naturalWidth / this.image.naturalHeight),
                  r < i ? ((t = o * r), (e = o)) : ((t = n), (e = n / r)),
                  { width: t, height: e }
                )
              },
            },
            {
              ...
              value: function () {
                if (this.store.state.custom_code.custom_js) {
                  ...
                  ;(t.innerHTML = this.store.state.custom_code.custom_js),
                    document.body.appendChild(t)
                }
                if (this.store.state.custom_code.custom_css) {
                  var e = document.createElement('style')
                  ;(e.innerHTML = this.store.state.custom_code.custom_css),
    ...
    ;(window.ImageMapPro.init = function (t, e) {
      var n,
        o = new We(t, e, arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : qe)
      window.ImageMapPro.instances[
        (null === (n = e.general) || void 0 === n ? void 0 : n.name) || 'Default'
      ] = o
    }),
      'undefined' != typeof $ &&
    ...
    ;(window.debug = function (t) {
      He ||
        ((He = document.createElement('div')).setAttribute('id', 'debug'),
        document.querySelector('body').appendChild(He)),
        (He.innerHTML = t),
        (He.style.transitionProperty = 'none'),
        (He.style.opacity = 1),
        clearInterval(Ye),
        clearTimeout(Ne),
        (Ne = setTimeout(function () {
          Ye = setInterval(function () {
            ;(He.style.opacity = 0.75 * He.style.opacity),
              He.style.opacity < 0.1 && ((He.style.opacity = 0), clearInterval(Ye))
          }, 50)
        }, 1e3))
    }),
